...
function buildAppCreationPrompt(input: {
  ...
  return [
    ...
    `Existing first-party apps are neighbors, not implementation details for this app. If the user's prompt mentions Mail, Calendar, Analytics, Brain, Assets, Dispatch, or other templates, treat them as existing hosted/connected apps that this app can link to or call through A2A/default connected agents. For example, Mail, Calendar, Analytics, Brain, and Assets already exist at https://mail.jami.studio, https://calendar.jami.studio, https://analytics.jami.studio, https://brain.jami.studio, and https://assets.jami.studio.`,
