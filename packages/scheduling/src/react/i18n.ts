...
const translations: Partial<Record<LocaleCode, Partial<SchedulingMessages>>> = {
  ...
  "zh-TW": {
    add: "新增",
    addField: "新增欄位",
    addEventTypeDescription: "建立新的可預約活動類型。",
    addEventTypeTitle: "新增活動類型",
    availableLeft: "剩餘",
    bookersChooseBetween: "預約者將在這些時長中選擇：{{durations}}",
    cancel: "取消",
    clickToEditSlug: "按一下以編輯短網址",
    clickToEditUsername: "按一下以編輯使用者名稱",
    checkbox: "核取方塊",
    company: "公司",
    companyPlaceholder: "你的公司名稱",
    conferencing: "會議",
    connectGoogle: "連接 Google",
    connectGoogleCalendar: "連接 Google 日曆",
    connectGoogleCalendarDescription: "建立日曆活動時會自動產生 Meet 連結。",
    connected: "已連接",
    connectZoom: "連接 Zoom",
    connectZoomAccount: "連接你的 Zoom 帳號",
    connectZoomAccountDescription:
      "我們會為每個預約建立真正的 Zoom 會議，無需貼上個人連結。",
    continue: "繼續",
    customFields: "自訂欄位",
    customFieldsEmpty:
      "新增自訂欄位以收集預約者資訊，例如 LinkedIn 個人檔案、公司名稱、電話號碼。",
    customLink: "自訂連結",
    ...
    email: "電子郵件",
    errorMessage: "錯誤訊息",
    errorMessageHint: "（模式不相符時顯示）",
    everyDay: "每天",
    fieldLabel: "欄位標籤",
    googleMeet: "Google Meet",
    googleMeetDescription: "自動產生 Meet 連結",
    inPersonOrOther: "實體或其他方式",
    label: "標籤",
    linkedInProfile: "LinkedIn 個人檔案",
    linkedInUrlError: "請輸入有效的 LinkedIn 個人檔案 URL",
    longText: "長文字",
    meeting: "meeting",
    meetingUrl: "會議 URL",
    minutes: "分鐘",
    ...
    phoneNumber: "電話號碼",
    placeholder: "預留文字",
    placeholderText: "預留文字",
    presets: "預設",
    regexOptional: "（正規表示式，選填）",
    removeField: "移除欄位",
    required: "必填",
    saving: "儲存中...",
    shortText: "短文字",
    shortDescriptionPlaceholder: "預約者會看到的簡短說明。",
    quickChatPlaceholder: "快速聊天",
    quickChatSlugPlaceholder: "quick-chat",
    optionListPlaceholder: "選項 1\n選項 2\n選項 3",
    validationPatternPlaceholder:
      "例如 ^https?://(www\\.)?linkedin\\.com/in/.+",
    validationErrorPlaceholder: "例如 請輸入有效的 LinkedIn URL",
    customMeetingUrlPlaceholder: "https://meet.example.com/room",
    title: "標題",
    to: "至",
    toggleDay: "切換{{day}}",
    ...
    unavailable: "無法預約",
    url: "URL",
    validationPattern: "驗證模式",
    website: "網站",
    weekdays: "平日",
    weekends: "週末",
    yourName: "your-name",
    zoom: "Zoom",
    zoomDescription: "為每個預約自動建立會議",
    zoomNotConfigured:
      "請管理員設定 ZOOM_CLIENT_ID 和 ZOOM_CLIENT_SECRET 以啟用 Zoom OAuth。",
    providerNotConfigured: "{{provider}} 尚未在此伺服器上設定。",
    providerNeedsCredentials: "{{provider}} 需要伺服器 OAuth 憑證才能使用。",
  },
  "es-ES": {
    add: "Añadir",
