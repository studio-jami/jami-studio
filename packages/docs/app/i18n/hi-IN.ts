...
const hiIN = {
  ...
  legal: {
    ...
    privacy: {
      ...
      intro:
        "यह नीति बताती है कि जब Jami Studio Agent-Native द्वारा होस्ट किए गए एप्लिकेशन, होस्ट किए गए टेम्प्लेट, डेमो और आधिकारिक ब्राउज़र एक्सटेंशन को संचालित करता है तो डेटा कैसे एकत्र, उपयोग, साझा और बनाए रखता है।",
      scopeCards: {
        hosted: {
          title: "होस्ट किए गए ऐप्स",
          body: "कवर किया गया जब Jami Studio आपके लिए Agent-Native सेवा या होस्टेड टेम्पलेट संचालित करता है।",
        },
        openSource: {
          title: "खुला स्रोत",
      ...
      paragraphs: {
        scope1:
          "Agent-Native खुला स्रोत है, और स्रोत कोड MIT लाइसेंस के तहत उपलब्ध है। यह नीति केवल Agent-Native उपयोगकर्ताओं के लिए Jami Studio द्वारा संचालित होस्ट किए गए एप्लिकेशन और सेवाओं पर लागू होती है। यह किसी अन्य व्यक्ति द्वारा कोड के उपयोग पर लागू नहीं होता है, जिसमें फोर्क्स, अनुकूलित टेम्पलेट, निजी परिनियोजन या स्वयं-होस्ट किए गए संस्करण शामिल हैं। यदि आप अपनी स्वयं की तैनाती संचालित करते हैं, तो आप अपनी डेटा प्रथाओं और गोपनीयता नीति के लिए स्वयं जिम्मेदार हैं।",
    ...
    terms: {
      ...
      title: "Agent-Native होस्ट किए गए एप्लिकेशन",
      intro:
        "ये शर्तें तब लागू होती हैं जब Jami Studio आपके लिए Agent-Native होस्टेड एप्लिकेशन, होस्टेड टेम्पलेट, डेमो और आधिकारिक होस्टेड सेवाएं संचालित करता है।",
      scopeCards: {
        hosted: {
          title: "होस्ट किए गए ऐप्स",
          body: "जब आप Agent-Native ऐप या Jami Studio द्वारा संचालित टेम्पलेट का उपयोग करते हैं तो कवर किया जाता है।",
        },
        openSource: {
          title: "खुला स्रोत",
      ...
      paragraphs: {
        scope1:
          "Agent-Native खुला स्रोत है, और इसका स्रोत कोड MIT लाइसेंस के तहत उपलब्ध है। ये शर्तें केवल Agent-Native उपयोगकर्ताओं के लिए Jami Studio द्वारा संचालित होस्ट किए गए एप्लिकेशन और सेवाओं पर लागू होती हैं। वे Jami Studio के बाहर संचालित फोर्क्स, कस्टम टेम्प्लेट, निजी परिनियोजन या स्व-होस्ट किए गए संस्करणों को नियंत्रित नहीं करते हैं।",
        ...
        hostedService:
          "Jami Studio होस्ट किए गए Agent-Native एप्लिकेशन, टेम्प्लेट, डेमो, साझा कार्यस्थान, ब्राउज़र एक्सटेंशन और संबंधित एजेंट वर्कफ़्लो प्रदान कर सकता है। उत्पाद के विकसित होने पर होस्ट की गई सेवा को अद्यतन, सीमित, निलंबित या बंद किया जा सकता है।",
        accounts1:
        ...
        content1:
          "आपके द्वारा बनाई गई, अपलोड की गई, रिकॉर्ड की गई, आयात की गई या होस्ट की गई Agent-Native ऐप्स से कनेक्ट की गई सामग्री का स्वामित्व आपके पास रहता है। आप Jami Studio को उस सामग्री को होस्ट करने, संसाधित करने, प्रसारित करने, प्रदर्शित करने, बदलने, विश्लेषण करने और संग्रहीत करने के लिए आवश्यक सीमित अनुमति देते हैं ताकि होस्ट किया गया ऐप और उसके एजेंट वर्कफ़्लो संचालित हो सकें।",
        content2:
        ...
        suspensionPrefix:
          "Jami Studio उपयोगकर्ताओं की सुरक्षा, कानून का अनुपालन, दुरुपयोग को रोकने, सुरक्षा जोखिम को संबोधित करने या सेवा को संचालित करने के लिए आवश्यक होने पर होस्ट की गई Agent-Native सेवाओं तक पहुंच को निलंबित या प्रतिबंधित कर सकता है। आप किसी भी समय होस्ट की गई सेवा का उपयोग बंद कर सकते हैं। जैसा कि इसमें वर्णित है, कुछ डेटा सीमित अवधि के लिए बैकअप, लॉग या ऑडिट रिकॉर्ड में रह सकता है",
        disclaimers1:
          "होस्ट की गई Agent-Native सेवाएँ लागू कानून और Jami Studio के साथ आपके किसी अलग लिखित समझौते के अधीन, यथा-और-उपलब्ध आधार पर प्रदान की जाती हैं। Jami Studio यह गारंटी नहीं देता है कि होस्ट किए गए ऐप्स, एकीकरण, ऑटोमेशन, या AI आउटपुट निर्बाध, त्रुटि-मुक्त होंगे, या हर आवश्यकता को पूरा करेंगे।",
        disclaimers2Prefix:
          "कानून द्वारा अनुमत अधिकतम सीमा तक, होस्ट की गई Agent-Native सेवाओं के लिए Jami Studio का दायित्व सीमित है जैसा कि Jami Studio के व्यापक विवरण में वर्णित है",
        disclaimers2Suffix:
