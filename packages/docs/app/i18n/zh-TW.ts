const messages = {
  ...
  templateLanding: {
    ...
    plan: {
      ...
      s028: "桌面檔案同步",
      s029: "將託管計畫從 Jami Studio Desktop 鏡像到本機 MDX 檔案，無需克隆應用程式或執行 CLI。",
      s030: "，因此審查位於程式碼旁邊。",
      s031: "它是如何運作的",
  ...
  skillsPage: {
    ...
    metaKeywords:
      "代理技能, visual plan, visual recap, visual edit, 編碼代理, Claude Code, Codex, PR 審查, 規劃, Jami Studio",
  ...
  downloadPage: {
    title: "下載 Jami Studio",
    body: "所有 Jami Studio 應用都在一個桌面外殼中。內建正式環境應用，並提供用於本機開發的開發模式開關。",
    openDesktop: "開啟 Jami Studio",
  ...
  legal: {
    ...
    privacy: {
      ...
      links: {
        builderPrivacy: "隱私政策",
        builderPrivacyFull: "Jami Studio 隱私政策",
      },
    },
    terms: {
      eyebrow: "服務條款",
      ...
      scopeCards: {
        ...
        selfHosted: {
          title: "自託管",
          body: "由您或其他人操作的單獨部署不是 Jami Studio 託管服務。",
        },
      },
      sections: {
        scope: "範圍和相關術語",
