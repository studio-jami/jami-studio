...
export const meta = () =>
  withDefaultSocialImage([
    { title: "Apps — Jami Studio" },
    {
      name: "description",
      content:
        "Build chat-first agentic apps, robust agent UIs, and automation-first workflows from replaceable Jami Studio modules and forkable example apps.",
    },
    {
      property: "og:title",
      content: "Apps — Jami Studio",
    },
    {
      ...
      <Link
        ...
        onClick={() =>
          trackEvent("click cta", {
            label: typeof children === "string" ? children : "apps",
            location,
          })
        }
      >
      ...
      <section className="relative border-b border-[var(--docs-border)] px-6 py-16 md:min-h-[calc(100svh-10rem)] md:py-20">
        ...
        <div className="relative z-10 mx-auto flex max-w-[1120px] flex-col items-center justify-center text-center md:min-h-[calc(100svh-24rem)]">
          <div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-[var(--docs-border)] bg-[color-mix(in_srgb,var(--bg)_88%,transparent)] px-4 py-1.5 text-sm text-[var(--fg-secondary)] backdrop-blur">
            ...
            <span className="truncate">Modules for agentic applications</span>
          </div>
          ...
          <div className="mt-9 flex w-full max-w-xl flex-col justify-center gap-3 sm:flex-row">
            <ArrowLink to="#modules" location="apps_hero">
              Browse modules
            </ArrowLink>
            <ArrowLink
              to="#example-apps"
        ...
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="mt-10 flex justify-center">
            <ArrowLink
              ...
              location="apps_example_apps"
              variant="secondary"
            >
              View the full app gallery
            </ArrowLink>
          </div>
        </div>
      </section>
