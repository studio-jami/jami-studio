...
फ्रेमवर्क URL से बोली का स्वतः पता लगाता है और तदनुसार Drizzle को कॉन्फ़िगर करता है। अंतर्निहित एडाप्टर Postgres URLs, libSQL/Turso URLs, SQLite फ़ाइल URLs और क्लाउडफ्लेयर D1 बाइंडिंग को कवर करते हैं। सामान्य उत्पादन विकल्पों में नियॉन, सुपाबेस, टुर्सो/libSQL, सादा Postgres, टिकाऊ SQLite, और उपलब्ध होने पर Jami Studio-प्रबंधित वातावरण शामिल हैं।

## Jami Studio प्रबंधित डेटाबेस {#builder-managed}

_योजनाबद्ध (अभी तक उपलब्ध नहीं):_ Jami Studio से कनेक्ट होने पर, आपका ऐप स्वचालित रूप से प्रावधानित प्रबंधित डेटाबेस का उपयोग करने में सक्षम होगा, बिना किसी कनेक्शन स्ट्रिंग की आवश्यकता के।
