---
title: "मूल चैट UI"
description: "एक्शन-घोषित देशी चैट रेंडरर्स, पुन: प्रयोज्य डेटाटेबल/डेटाचार्ट आउटपुट, और BYO एजेंट रनटाइम को Jami Studio चैट से कैसे कनेक्ट होना चाहिए।"
---
...
रखते हुए सामान्यीकृत घटनाओं को Jami Studio की बातचीत UI में स्ट्रीम करें
...
<Diagram id="doc-block-1kaurl9" title={"BYO रनटाइम Jami Studio चैट शेल रखता है"} summary={"आपका बाहरी एजेंट एक कनेक्टर के माध्यम से सामान्यीकृत घटनाओं को स्ट्रीम करता है; Jami Studio कंपोज़र, ट्रांसक्रिप्ट, टूल कार्ड, अनुमोदन और मूल विजेट रखता है।"}>
...
जब आप रनटाइम ऑब्जेक्ट के रूप में अंतर्निहित Jami Studio ट्रांसपोर्ट चाहते हैं, तो इसका उपयोग करें:
...
संपूर्ण बाहरी प्रतिलेख का स्वामी है और केवल Jami Studio का कंपोजर चाहता है
फ़ील्ड.
