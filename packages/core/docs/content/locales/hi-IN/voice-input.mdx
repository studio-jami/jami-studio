---
title: "वॉइस इनपुट"
description: "एजेंट चैट कंपोजर में वॉयस डिक्टेशन - Jami Studio जेमिनी, BYOK प्रदाता, और ब्राउज़र वेब स्पीच फ़ॉलबैक।"
---
...
फ्रेमवर्क यह सब स्वचालित रूप से संभालता है। Jami Studio-कनेक्टेड उपयोगकर्ताओं को डिफ़ॉल्ट रूप से Jami Studio-होस्टेड जेमिनी फ्लैश-लाइट मिलता है; अन्यथा उपयोगकर्ता अपनी स्वयं की प्रदाता कुंजी ला सकते हैं या ब्राउज़र वाक् पहचान पर वापस आ सकते हैं।
...
स्पीच मॉडल चैट वाले उन्हीं प्रमाणीकृत Jami Studio टूल का उपयोग करता है, इसलिए वह बोलते समय ऐप में नेविगेट कर सकता है और कार्रवाइयाँ चला सकता है। जिन कार्रवाइयों के लिए स्वीकृति चाहिए, वे आपकी स्वीकृति मिलने तक रुकी रहती हैं। केवल उपयोगकर्ता और सहायक के पूरे हुए टेक्स्ट कथन मूल चैट थ्रेड में जोड़े जाते हैं। वॉइस मोड बंद करने पर चैट खुल जाती है ताकि आप टेक्स्ट में आगे बढ़ सकें; ऑडियो या अंतरिम ट्रांसक्रिप्ट अंश सहेजे नहीं जाते। एक रीयलटाइम सत्र अधिकतम 60 मिनट तक चलता है।

## यह कैसे काम करता है {#how-it-works}

संगीतकार का आवाज बटन ब्राउज़र में ऑडियो रिकॉर्ड करता है, फिर एक प्रदाता चुनता है:

1. **Jami Studio जेमिनी फ्लैश-लाइट (Jami Studio कनेक्ट होने पर डिफ़ॉल्ट)।** ब्राउज़र `/_agent-native/transcribe-voice` पर ऑडियो पोस्ट करता है, जो जेमिनी फ्लैश-लाइट का उपयोग करके Jami Studio के माध्यम से प्रॉक्सी करता है। किसी Google API कुंजी की आवश्यकता नहीं है।
...
<div class="diagram-voice">
  ...
  <div class="diagram-card col">
    ...
    <small class="diagram-muted">Jami Studio कनेक्ट होने पर डिफ़ॉल्ट</small>
...
Jami Studio सबसे आसान रास्ता है: सेटिंग्स से Jami Studio कनेक्ट करें और डिफ़ॉल्ट प्रदाता Jami Studio जेमिनी फ्लैश-लाइट बन जाता है। BYOK प्रदाताओं के लिए, सेटिंग्स → API कुंजी में मिलान कुंजी जोड़ें।
