...
यह फ्रेमवर्क के आंतरिक ब्राउज़र टेलीमेट्री (`trackEvent()` / स्वचालित पेजव्यू - नीचे [Browser defaults](#browser-defaults) देखें) से अलग है, जो Jami Studio के स्वयं के उत्पाद विश्लेषण को शक्ति प्रदान करता है। अपने ऐप के स्वयं के एनालिटिक्स इवेंट के लिए `track()` का उपयोग करें जो आपके कॉन्फ़िगर किए गए प्रदाताओं तक पहुंचना चाहिए।

## Session replay {#session-replay}

Jami Studio ऐप्स दूसरा एनालिटिक्स SDK जोड़े बिना फर्स्ट-पार्टी ब्राउज़र session replay को ऑप्ट इन कर सकते हैं। ब्राउज़र रूट में एक बार `configureTracking()` को कॉल करें और Analytics पब्लिक की के साथ collector endpoint पास करें:
...
Jami Studio टेम्पलेट रूट पहले से ही `configureTracking()` को कॉल करते हैं। होस्टेड टेम्पलेट डिप्लॉयमेंट Vite/Netlify एनवायरनमेंट वेरिएबल्स के साथ replay चालू कर सकते हैं, जबकि लाइब्रेरी उपभोक्ताओं को ऊपर दिए गए स्पष्ट `configureTracking({ key, endpoint, sessionReplay })` फॉर्म को प्राथमिकता देनी चाहिए:
...
फ्रेमवर्क कनेक्ट Jami Studio CTAs से `builder connect clicked` को भी ट्रैक करता है, और सर्वर-साइड Jami Studio कनेक्ट रूट प्रारंभ/सफल/असफल जीवनचक्र घटनाओं को ट्रैक करता है। `configureTracking()` को फ्रेमवर्क द्वारा स्वचालित रूप से कॉल किया जाता है; आपको इसे अपने टेम्पलेट कोड में कॉल करने की आवश्यकता नहीं है।
