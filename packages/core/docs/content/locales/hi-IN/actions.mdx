...
एक परिभाषा, सात उपभोक्ता। यह [ladder](/docs/what-is-jami#the-ladder) का तीसरा पायदान है।
...
<div class="diagram-fanout">
  ...
  <div class="diagram-grid">
    ...
    <div class="diagram-node">
      A2A टूल<br /><small class="diagram-muted">अन्य Jami Studio ऐप्स</small>
    </div>
    <div class="diagram-node">
...
<Endpoint id="doc-block-1msf0yi" title={"अपने आप mount हुआ action endpoint"} method="GET" path="/_agent-native/actions/get-lead" summary={"हर action यहां अपने आप mount होता है - filename ही action name है।"} auth={"Session cookie; frontend calls `X-Jami Studio-Frontend: 1` लेकर चलते हैं"} params={[
  {
    "name": "leadId",
    "in": "query",
    "type": "string",
...
| `"frontend"` | `useActionMutation` / `useActionQuery` / `callAction` के माध्यम से एक ब्राउज़र कॉल (`X-Jami Studio-Frontend: 1` हेडर के साथ टैग किया गया)। |
