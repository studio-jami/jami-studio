...
description: "साझा स्थानीय कैटलॉग, एक भाषा पिकर, ब्राउज़र-भाषा फ़ॉलबैक और स्थानीय-जागरूक डॉक्स सामग्री के साथ Jami Studio ऐप्स को स्थानीयकृत करें।"
---

# अंतर्राष्ट्रीयकरण

Jami Studio ऐप्स साझा के माध्यम से फ्रेमवर्क और टेम्पलेट UI को स्थानीयकृत कर सकते हैं
