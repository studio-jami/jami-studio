...
| `clips`        | खोज, आयात, मीटिंग्स          | मस्तिष्क, क्लिप                 |
...
Dispatch ऐसे control-plane actions उपलब्ध कराता है जो उन्हीं shared store functions का उपयोग करते हैं जिन्हें कोई ऐप सीधे कॉल कर सकता है — इसका `upsert-workspace-connection` action provider catalog के विरुद्ध input को validate करता है, फिर इसी पृष्ठ पर दिखाए गए `upsertWorkspaceConnection()` को delegate करता है:
...
- [**Dispatch**](/docs/dispatch) — वह ऐप जो आम तौर पर workspace connection setup और vault का स्वामी होता है
- [**सुरक्षा**](/docs/security) — credential vault, secret scoping और access model जिनकी ओर connections संकेत करते हैं
- [**Onboarding**](/docs/onboarding#checking-workspace-connections-in-onboarding) — template setup checklist से connection readiness जाँचना
- [**MCP Clients**](/docs/mcp-clients) — workspace में MCP server credentials साझा करने का संबंधित reusable-config pattern
- [**Brain**](/docs/template-brain) — इस model पर आधारित provider Sources page का reference implementation
