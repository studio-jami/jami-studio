...
एक बटन जो एजेंट को काम सौंपता है (इनलाइन `llm()` कॉल चलाने के बजाय - [ladder](/docs/what-is-jami#the-ladder) से एंटी-पैटर्न):
...
- **अपना स्वयं का एजेंट रनटाइम लाएँ।** यदि आपने कोई एजेंट कहीं और बनाया है तो उसे लाना चाहिए
  बातचीत को सशक्त बनाएं जबकि Jami Studio कंपोजर, ट्रांसक्रिप्ट, टूल रखता है
...
जब UI को समान ऑपरेशन चलाने की आवश्यकता होती है तो एक एजेंट टूल चलेगा - [ladder](/docs/what-is-jami#rung-three) का क्रमांक 3 - `useActionMutation` का उपयोग करें:
