...
Jami Studio CLI को स्थानीय एजेंटों के लिए डिफ़ॉल्ट दस्तावेज़ पथ के रूप में रखें क्योंकि यह
MCP कनेक्टर को भी पंजीकृत करता है। `Jami Studio/agent-native` एक वास्तविक GitHub
...
स्थान. नए कॉपी किए गए Jami Studio skills में एक `agent-native-skill.json` शामिल है
मार्कर ताकि भविष्य की स्थिति आउटपुट स्रोत और हैश की पहचान कर सके।

जेनरेटेड Jami Studio ऐप्स और वर्कस्पेस में फ्रेमवर्क-प्रदत्त भी शामिल है
