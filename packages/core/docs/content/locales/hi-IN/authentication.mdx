...
| प्रथम-पक्ष द्वारा होस्ट किया गया (`*.jami.studio`) | प्रति ऐप पृथक नामस्थान (प्रत्येक का अपना प्रमाणीकरण डेटाबेस है); `COOKIE_DOMAIN=.jami.studio` को डिफ़ॉल्ट रूप से अनदेखा कर दिया जाता है |
