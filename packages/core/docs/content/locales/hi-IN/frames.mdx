...
- **Jami Studio क्लाउड फ्रेम** - सहयोग के साथ एक प्रबंधित, होस्ट किया गया फ्रेम,
...
<div class="diagram-frames">
  ...
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">Jami Studio क्लाउड फ्रेम</span
...
- **कोड मोड** - साझा कोडिंग टूल जोड़ता है (`bash`, `read`, `edit`, `write`)
  ...
  संवाद बताता है कि कोड परिवर्तन के लिए Jami Studio डेस्कटॉप या Jami Studio की आवश्यकता है;
...
<Diagram id="doc-block-k2k7s3" title={"कोड-अनुरोध गेटिंग"} summary={"कोड-टाइप किए गए संदेश को कोड-सक्षम फ़्रेम की आवश्यकता होती है। एक कनेक्टेड के साथ, अनुरोध मार्ग वहां; बिना किसी के, पैनल बताता है कि कोड परिवर्तन के लिए Desktop या Jami Studio की आवश्यकता होती है।"}>
...
| Jami Studio | `builder`  | (अंतर्निहित)                |
...
## Jami Studio क्लाउड फ़्रेम {#cloud-frame}

[Jami Studio](https://www.jami.studio) एक प्रबंधित फ़्रेम प्रदान करता है जो
...
एम्बेडेड पैनल रूट से Jami Studio फ्रेम तक कोड अनुरोध उसी तरह
