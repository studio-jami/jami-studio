...
### Jami Studio: प्रोडक्शन में विजुअल एडिटिंग {#visual-editing-in-production}

[Jami Studio](https://www.jami.studio) एक प्रबंधित क्लाउड वातावरण प्रदान करके इसे हल करता है जहां एजेंट उत्पादन में आपके ऐप के UI को संशोधित करने की क्षमता रखता है। अपने रेपो को Jami Studio से कनेक्ट करें और सीधे UI परिवर्तनों के लिए संकेत दें - किसी पुनः तैनाती की आवश्यकता नहीं है।

**यह कैसे काम करता है:**

1. अपने एजेंट-मूल रेपो को Jami Studio से कनेक्ट करें
2. Jami Studio एजेंट, विज़ुअल संपादन और वास्तविक समय सहयोग के साथ एक क्लाउड फ्रेम प्रदान करता है
...
- [**Frames**](/docs/frames) — production UI बदलावों के लिए embedded agent panel और Jami Studio cloud frame की तुलना
