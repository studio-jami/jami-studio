...
Jami Studio एक पूर्ण साइडबार शिप करता है, लेकिन साइडबार अनुबंध नहीं है। द
...
| `createAgentChatAdapter()`           | `@agent-native/core/client` या `/client/chat` | आपको निम्न-स्तरीय सहायक-यूआई एडाप्टर के रूप में अंतर्निहित Jami Studio SSE ट्रांसपोर्ट की आवश्यकता है। |
...
बातचीत जबकि Jami Studio कंपोजर, ट्रांसक्रिप्ट, टूल कार्ड और रखता है
