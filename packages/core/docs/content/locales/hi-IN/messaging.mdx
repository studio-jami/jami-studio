...
- **क्लिप्स ऐप खुलता है** - Slack के लिए इंस्टॉल करने योग्य Jami Studio क्लिप्स `SLACK_CLIENT_ID`, `SLACK_CLIENT_SECRET`, `SLACK_SIGNING_SECRET` और `/api/slack/oauth/callback` का उपयोग करता है। प्रत्येक कनेक्टेड Slack कार्यक्षेत्र को `app_secrets` में अपना स्वयं का एन्क्रिप्टेड बॉट टोकन मिलता है; `SLACK_BOT_TOKEN` केवल एक लीगेसी सिंगल-वर्कस्पेस फ़ॉलबैक है।
...
में Jami Studio आइकन अपलोड करें, ताकि Agents चयनकर्ता उत्पाद की ब्रांडिंग से मेल खाए।
...
व्यक्तिगत Slack DM केवल सत्यापित Jami Studio संगठन सदस्य या पहले से लिंक की गई Slack
