...
> नोट: बेयर `npx skills@latest add studio-jami/jami-studio --skill visual-plan` (वर्सेल/ओपन Skills CLI) **केवल निर्देश** स्थापित करता है - यह MCP कनेक्टर को पंजीकृत नहीं करता है। जब आप कनेक्टर को भी वायर्ड करना चाहते हैं तो ऊपर दिए गए Jami Studio CLI का उपयोग करें।

### Claude कोड (प्लगइन) {#claude-code}

सार्वजनिक `studio-jami/jami-studio` रेपो स्वयं एक Claude कोड प्लगइन मार्केटप्लेस है, इसलिए आप इसे सीधे जोड़ते हैं - कोई बिल्ड चरण नहीं। Claude कोड के अंदर:
...
**इसे वितरित या स्थापित करने के लिए किसी सबमिशन या समीक्षा की आवश्यकता नहीं है।** `studio-jami/jami-studio` एक स्व-होस्टेड, सार्वजनिक गिट मार्केटप्लेस है, इसलिए उपयोगकर्ता इसे सीधे ऊपर दिए गए कमांड के साथ **Claude कोड और Codex** दोनों पर जोड़ते हैं - कोई आवेदन या अनुमोदन नहीं। सार्वभौमिक CLI मार्ग को किसी बाज़ार की आवश्यकता नहीं है।
