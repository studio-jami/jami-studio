...
- **प्लान MCP कनेक्टर** - `https://plan.jami.studio` (MCP एंडपॉइंट `https://plan.jami.studio/mcp`, सर्वर नाम `plan`) पर होस्ट किए गए ऐप के खिलाफ पंजीकृत है।
...
इंस्टॉल करने के बाद, **एक नया Codex थ्रेड शुरू करें** ताकि skills और MCP टूल सत्र में लोड हो जाएं। प्लगइन एक URL-केवल कनेक्टर (`[mcp_servers.plan]` → `https://plan.jami.studio/mcp`) शिप करता है; `codex mcp login plan` OAuth प्रवाह चलाता है। उपरोक्त सार्वभौमिक CLI मार्ग Codex (`npx @agent-native/core@latest skills add visual-plan --client codex`) के लिए भी काम करता है यदि आप एक कमांड पसंद करते हैं जो एक साथ स्थापित और प्रमाणित करता है, या जब आप स्थानीय-फ़ाइलें या स्वयं-होस्टेड मोड चाहते हैं।
