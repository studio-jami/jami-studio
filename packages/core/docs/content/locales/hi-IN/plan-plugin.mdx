...
> नोट: बेयर `npx skills@latest add Jami Studio/agent-native --skill visual-plan` (वर्सेल/ओपन Skills CLI) **केवल निर्देश** स्थापित करता है - यह MCP कनेक्टर को पंजीकृत नहीं करता है। जब आप कनेक्टर को भी वायर्ड करना चाहते हैं तो ऊपर दिए गए Agent-Native CLI का उपयोग करें।
