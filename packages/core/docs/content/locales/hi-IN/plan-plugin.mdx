...
description: "Jami Studio Plan skills (/visual-plan, /visual-recap, /visualize-repo) और hosted Plan MCP connector को Claude Code या Codex प्लगइन के रूप में, या universal CLI के साथ install करें। Updates कैसे काम करते हैं और क्या आपको कुछ submit करना है।"
---

# प्लान प्लगइन और मार्केटप्लेस

Jami Studio **Plan** app एक installable bundle के रूप में आता है। एक ही install Plan slash-command skills जोड़ता है **और** hosted Plan MCP connector को wire करता है, ताकि agent plans generate कर सके और skills उन्हें सीधे Plan app में publish कर सकें।
...
- **प्लान MCP कनेक्टर** - `https://plan.jami.studio` (MCP एंडपॉइंट `https://plan.jami.studio/_agent-native/mcp`, सर्वर नाम `plan`) पर होस्ट किए गए ऐप के खिलाफ पंजीकृत है।
...
यह योजना सामग्री को Jami Studio योजना डेटाबेस से बाहर रखता है। होस्ट किया गया साझाकरण,
...
Jami Studio डेस्कटॉप में होस्ट की गई योजनाओं के लिए एक अलग स्थानीय-फ़ाइल सिंक पथ है:
...
> प्लगइन (`agent-native-visual-plans`) में ऐप आईडी `visual-plans` है, यही कारण है कि Claude कोड प्लगइन नाम और Codex प्लगइन नाम दोनों `agent-native-visual-plans` हैं। प्लान ऐप का डिस्प्ले नाम "Jami Studio प्लान" है।
...
- `--no-connect` - प्रमाणीकरण के बिना कनेक्टर को पंजीकृत करें; बाद में `npx @agent-native/core@latest connect https://plan.jami.studio --client all` चलाएँ, या एक संकीर्ण `--client` चुनें।
...
> नोट: बेयर `npx skills@latest add Jami Studio/agent-native --skill visual-plan` (वर्सेल/ओपन Skills CLI) **केवल निर्देश** स्थापित करता है - यह MCP कनेक्टर को पंजीकृत नहीं करता है। जब आप कनेक्टर को भी वायर्ड करना चाहते हैं तो ऊपर दिए गए Jami Studio CLI का उपयोग करें।

### Claude कोड (प्लगइन) {#claude-code}

सार्वजनिक `Jami Studio/agent-native` रेपो स्वयं एक Claude कोड प्लगइन मार्केटप्लेस है, इसलिए आप इसे सीधे जोड़ते हैं - कोई बिल्ड चरण नहीं। Claude कोड के अंदर:
...
इंस्टॉल करने के बाद, **एक नया Codex थ्रेड शुरू करें** ताकि skills और MCP टूल सत्र में लोड हो जाएं। प्लगइन एक URL-केवल कनेक्टर (`[mcp_servers.plan]` → `https://plan.jami.studio/_agent-native/mcp`) शिप करता है; `codex mcp login plan` OAuth प्रवाह चलाता है। उपरोक्त सार्वभौमिक CLI मार्ग Codex (`npx @agent-native/core@latest skills add visual-plan --client codex`) के लिए भी काम करता है यदि आप एक कमांड पसंद करते हैं जो एक साथ स्थापित और प्रमाणित करता है, या जब आप स्थानीय-फ़ाइलें या स्वयं-होस्टेड मोड चाहते हैं।

> **पुराने इंस्टॉल:** यदि आपके कॉन्फिगरेशन में अभी भी URL पर इंगित करने वाली `agent-native-plans` प्रविष्टि है, तो Codex के लिए `npx -y @agent-native/core@latest reconnect https://plan.jami.studio --client codex` चला रहा है, या आपके लक्ष्य `--client` के साथ एक ही कमांड चल रहा है, इसे कैनोनिकल `plan` नाम में समेकित करता है।
...
**इसे वितरित या स्थापित करने के लिए किसी सबमिशन या समीक्षा की आवश्यकता नहीं है।** `Jami Studio/agent-native` एक स्व-होस्टेड, सार्वजनिक गिट मार्केटप्लेस है, इसलिए उपयोगकर्ता इसे सीधे ऊपर दिए गए कमांड के साथ **Claude कोड और Codex** दोनों पर जोड़ते हैं - कोई आवेदन या अनुमोदन नहीं। सार्वभौमिक CLI मार्ग को किसी बाज़ार की आवश्यकता नहीं है।
