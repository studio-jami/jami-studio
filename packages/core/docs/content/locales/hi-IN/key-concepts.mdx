...
एजेंट-नेटिव ऐप्स हुड के तहत कैसे काम करते हैं - सिद्धांत और वास्तुकला। यह पृष्ठ अनुबंध है; इस तरह से निर्माण की दृष्टि और मामले के लिए, [What Is Jami?](/docs/what-is-jami) देखें।
...
हेडलेस ऐप्स `pnpm agent` वाले फ़ोल्डर से समान प्रोडक्शन ऐप-एजेंट लूप चला सकते हैं, जबकि UI ऐप्स एम्बेडेड एजेंट पैनल को माउंट करते हैं और `pnpm dev` के साथ स्थानीय रूप से चला सकते हैं। क्लाउड में, Jami Studio एक प्रबंधित फ्रेम प्रदान करता है - वह वातावरण जो आपके ऐप के बगल में एजेंट को होस्ट करता है - टीमों के लिए सहयोग, दृश्य संपादन और प्रबंधित बुनियादी ढांचे के साथ।
...
एक _frame_ वह वातावरण है जो आपके ऐप के बगल में एजेंट को होस्ट करता है - स्थानीय रूप से वह एम्बेडेड पैनल है; बादल में यह Jami Studio की प्रबंधित सतह है। [Frames](/docs/frames) देखें.
...
- **एम्बेडेड एजेंट पैनल** - चैट और वैकल्पिक CLI टर्मिनल प्रत्येक ऐप में बनाया गया है। Claude कोड, Codex, जेमिनी, ओपनकोड और Jami Studio को सपोर्ट करता है। स्थानीय स्तर पर चलता है. मुफ़्त और खुला स्रोत.
...
- [**What Is Jami?**](/docs/what-is-jami) — इन नियमों के पीछे की दृष्टि और दर्शन
