...
- **छवियां और वीडियो बनाएं।** Jami Studio-प्रबंधित छवि निर्माण सक्षम होने पर उपलब्ध है, और जेमिनी वीडियो निर्माण के साथ-साथ मैन्युअल छवि फ़ॉलबैक को भी शक्ति प्रदान करता है।
...
लाइव डेमो: [assets.jami.studio](https://assets.jami.studio).
...
1. **एक बार इंस्टॉल करें।** यह कौशल निर्देश जोड़ता है और होस्टेड MCP कनेक्टर को एक साथ पंजीकृत करता है:
   ...
   ```बैश
   npx skills@latest जोड़ें Jami Studio/एजेंट-नेटिव --कौशल संपत्ति
   ```

   वर्सेल/ओपन Skills CLI केवल निर्देश फ़ाइल स्थापित करता है; ऐसा नहीं है
   MCP कनेक्टर सेटअप चलाएँ। जब आप चाहें तो ऊपर दिए गए Jami Studio CLI पथ का उपयोग करें
   एक-कमांड सेटअप।
