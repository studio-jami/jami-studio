...
`https://plan.jami.studio/mcp` - क्लाइंट-विशिष्ट सेटअप के लिए [MCP Clients](/docs/mcp-clients) देखें।
...
- ऐप का अपना डिफ़ॉल्ट चैट मॉडल Sonnet 5 है; इसे किसी भी समय **सेटिंग्स** में बदलें। Haiku सस्ता Claude विकल्प है, और Luna GPT-5.6 परिवार में सस्ता विकल्प है।
...
होस्ट किया गया प्लान कनेक्टर `https://plan.jami.studio/mcp` पर रहता है।
