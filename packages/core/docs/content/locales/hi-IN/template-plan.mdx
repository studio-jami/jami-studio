...
Jami Studio प्लान कोडिंग एजेंटों के लिए विज़ुअल प्लान मोड है। यह एक साधारण
...
Jami Studio CLI का उपयोग करें। यह अनुशंसित सेटअप है क्योंकि यह
...
`https://plan.jami.studio/_agent-native/mcp` - क्लाइंट-विशिष्ट सेटअप के लिए [MCP Clients](/docs/mcp-clients) देखें।
...
कनेक्टर, इसलिए जब आप वन-कमांड सेटअप चाहते हैं तो Jami Studio CLI पथ का उपयोग करें।

> **एक-इंस्टॉल प्लगइन को प्राथमिकता दें?** Claude कोड और Codex जोड़ सकते हैं
> `Jami Studio/agent-native` सीधे एक प्लगइन मार्केटप्लेस के रूप में, जो बंडल करता है
...
और इसमें VS के लिए मौजूदा Jami Studio MCP कनेक्ट फ्लो को चलाने के लिए एक कमांड शामिल है
...
होस्ट किया गया प्लान कनेक्टर `https://plan.jami.studio/_agent-native/mcp` पर रहता है।
...
स्थानीय-फ़ाइलें मोड योजना या पुनर्कथन सामग्री को Jami Studio पर जाने से रोकता है
...
Jami Studio डेस्कटॉप होस्ट किए गए प्लान को एक मूल स्थानीय-फ़ोल्डर ब्रिज भी देता है। यह
...
Jami Studio डेस्कटॉप में एक योजना खोलें, योजना मेनू की **स्थानीय फ़ाइलें** actions का उपयोग करें,
फिर:
...
- [**Skills**](/docs/skills-guide) - Jami Studio skills कैसे स्थापित करता है
