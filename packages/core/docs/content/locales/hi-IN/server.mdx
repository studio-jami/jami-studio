...
सिर्फ इसलिए कि ऐप केवल API है, आपको Express सर्वर की आवश्यकता नहीं है। Jami Studio ऐप में पहले से Nitro/H3 सर्वर शामिल होता है, और `defineAction()` डिफ़ॉल्ट API सतह है। संचालन को `actions/` में परिभाषित करें; फ़्रेमवर्क हर action को schema validation और request context के साथ `/_agent-native/actions/<name>` पर माउंट करता है।
...
चैट, जिसमें Jami Studio, एंथ्रोपिक, AI SDK प्रदाता, उपयोगकर्ता/ऐप मॉडल डिफ़ॉल्ट शामिल हैं,
