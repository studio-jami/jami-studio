---
title: "हार्नेस एजेंट"
description: "Claude कोड, Codex, Pi और अन्य पूर्ण कोडिंग हार्नेस को Jami Studio के अंदर एम्बेडेड एजेंट के रूप में चलाएं, अपने स्वयं के लूप, सैंडबॉक्स, देशी टूल और फिर से शुरू करने योग्य SQL-समर्थित सत्रों के साथ।"
...
> Codex, Pi) एजेंट के रूप में Jami Studio में। एक ऐप बना रहे हैं? से प्रारंभ करें
...
अनुमोदन मॉडल, और सैंडबॉक्स व्यवहार। Jami Studio इन्हें
...
स्वयं का लूप शुरू से अंत तक होता है, इसलिए Jami Studio इसे एक सत्र के रूप में चलाता है, एकल के रूप में नहीं
मॉडल कॉल.

<Diagram id="doc-block-19f4tip" title={"एक हार्नेस का अपना लूप होता है; Jami Studio सत्र चलाता है"} summary={"एजेंटहार्नेस सब्सट्रेट creates/resumes मूल सत्र, इसकी घटनाओं को सामान्य प्रतिलेख में स्ट्रीम करता है, और मोड़ों के बीच SQL में फिर से शुरू करता है।"}>
...
| एक Claude-कोड/Codex-शैली प्रस्तुत करें **कोडिंग कार्यक्षेत्र UI**                  | [Jami Studio Code UI](/docs/code-agents-ui) |
...
आसन्न सतहें: अपने द्वारा बनाए गए एजेंट को Jami Studio की चैट के पीछे कहीं और रखें
...
Jami Studio एक [ACP](https://agentclientprotocol.com) (एजेंट क्लाइंट) के रूप में कार्य कर सकता है
...
- **Jami Studio कोड / डेस्कटॉप** उपयोगकर्ता की मशीन पर `codex exec` चलाता है। यदि
...
- **`ai-sdk-harness:codex`** `@ai-sdk/harness-codex` को लोड करता है, जो Codex को चलाता है
  ...
  Jami Studio स्थानीय Codex CLI ऑथ फ़ाइल को इससे पहले सैंडबॉक्स में कॉपी करता है
...
एक हार्नेस लंबे समय तक जीवित रहने वाली मूल सत्र स्थिति का मालिक होता है। Jami Studio इसे SQL
ताकि एक थ्रेड घुमावों, प्रक्रियाओं और तैनाती के दौरान जीवित रह सके। `resumeState`
**अपारदर्शी** है - Jami Studio इसे संग्रहीत करता है और वापस सौंप देता है, लेकिन कभी निरीक्षण नहीं करता या
...
जानबूझकर सेट** Jami Studio actions से `createSession.tools` तक जब आप
...
एक हार्नेस सत्र `AgentHarnessEvent` मानों को स्ट्रीम करता है, जो Jami Studio
...
- पूरे Jami Studio चैट इतिहास को हर बार हार्नेस में दोबारा न चलाएं। फिर से शुरू करें
...
- [Jami Studio Code UI](/docs/code-agents-ui) - पुन: प्रयोज्य कोडिंग कार्यक्षेत्र सतह।
