...
> "जब कोई @jami.studio ईमेल से मीटिंग बुक करता है, तो मुझे Slack में संदेश भेजें।"
...
**उपयोगकर्ता:** "जब कोई @jami.studio ईमेल से बुकिंग करता है, तो मुझे Slack में संदेश भेजें।"
