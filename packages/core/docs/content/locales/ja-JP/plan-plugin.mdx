...
- **プラン MCP コネクタ** — `https://plan.jami.studio` (MCP エンドポイント `https://plan.jami.studio/mcp`、サーバー名 `plan`) でホストされているアプリに対して登録されています。
