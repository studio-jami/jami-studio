...
ライブデモ: [content.jami.studio](https://content.jami.studio)。
...
と `resources/`。ローカル コンテンツ アプリ、Jami Studio デスクトップ、または信頼できる場合
...
読み取りと書き込みのための、Jami Studio デスクトップ内の保護されたネイティブ フォルダー ブリッジ
...
モードと Jami Studio デスクトップ、および Finder で表示は、
...
コンテンツをローカルに保存するか、Jami Studio デスクトップを使用して、選択したワークスペース パスを使用できるようにします。
