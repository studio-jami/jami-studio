...
也可以由 Codex、Claude 代码、Jami Studio 侧边栏代理或普通编辑
编辑器。
...
或 Jami Studio 桌面桥公开它们。如果没有桥在运行，则该技能
...
普通托管浏览器文件夹访问。如果你打开`content.jami.studio`，
...
本地内容或使用 Jami Studio Desktop，以便受信任的本地网桥可以
