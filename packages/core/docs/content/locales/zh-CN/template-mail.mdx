...
现场演示：[mail.jami.studio](https://mail.jami.studio)。

> **Google 可能会显示警告：** 托管演示使用 Jami Studio 的共享 Google 应用程序进行 Gmail 访问，因此 Google 可能会要求您确认后再继续。在本地运行以使用您自己的 Google OAuth 客户端。
