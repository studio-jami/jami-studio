...
将 Jami Studio CLI 保留为本地代理的默认文档路径，因为它
还注册 MCP 连接器。 `Jami Studio/agent-native`是真正的GitHub
...
地点。新复制的 Jami Studio skills 包括 `agent-native-skill.json`
标记，以便将来的状态输出可以识别源和哈希值。

生成的 Jami Studio 应用程序和工作区还包括框架提供的
