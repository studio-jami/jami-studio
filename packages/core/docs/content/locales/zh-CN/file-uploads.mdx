---
title: "文件上传"
description: "配置文件上传存储 - 用于开发的 SQL 后备、Jami Studio 或用于生产的自定义提供程序。"
---
...
2. **Jami Studio 提供程序** — 内置，连接 Jami Studio 时自动激活
...
## Jami Studio 托管 {#builder-hosting}

当您的应用连接到 Jami Studio 时，文件上传会自动路由到 Jami Studio 的资产托管。文件由 CDN 提供，无需配置。这是推荐的生产设置。
