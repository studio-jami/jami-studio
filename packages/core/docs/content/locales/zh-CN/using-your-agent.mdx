...
agent-native 背后的定义思想是，agent 和 UI 是**平等的伙伴** - 请参阅 [What Is Jami?](/docs/what-is-jami) 了解原因。本节介绍该承诺的另一半：一旦代理停靠在您的应用旁边，实际使用该代理的感觉如何。
...
**声音。**作曲家有麦克风。口述请求而不是键入请求，提供程序选项范围从 Jami Studio 的托管转录到自带密钥到浏览器后备。
