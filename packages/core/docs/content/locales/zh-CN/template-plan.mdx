...
`https://plan.jami.studio/mcp` — 请参阅 [MCP Clients](/docs/mcp-clients) 以了解特定于客户端的设置。
...
- 应用自身的默认聊天模型是 Sonnet 5；你可以随时在 **设置** 中更改它。Haiku 是更便宜的 Claude 选项，Luna 是 GPT-5.6 系列中更便宜的选项。
...
托管计划连接器位于 `https://plan.jami.studio/mcp`。
切勿将共享机密放入技能文件中。
