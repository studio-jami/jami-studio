...
现场演示：[content.jami.studio](https://content.jami.studio)。
...
和`resources/`。当本地内容应用、Jami Studio 桌面或受信任
...
模式和 Jami Studio 桌面，以及在 Finder 中显示可通过
桌面桥或服务器支持的本地文件模式。
...
本地内容或使用 Jami Studio Desktop，以便选定的工作空间路径可以
