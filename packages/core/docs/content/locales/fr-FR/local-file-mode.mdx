...
être également modifié par Codex, Claude Code, l'agent de la barre latérale Jami Studio ou un utilisateur normal
éditeur.
...
ou le pont Jami Studio Desktop les expose. Si aucun pont ne fonctionne, la compétence
...
accès simple au dossier du navigateur hébergé. Si vous ouvrez `content.jami.studio`,
...
Contenu localement ou utilisez Jami Studio Desktop pour que le pont local de confiance puisse
