...
> "Lorsque quelqu'un réserve une réunion avec un e-mail @jami.studio, envoyez-moi un message en Slack."
...
**Utilisateur :** "Lorsque quelqu'un réserve avec un e-mail @jami.studio, envoyez-moi un message en Slack."
