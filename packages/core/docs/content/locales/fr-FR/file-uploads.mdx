...
description: "Configurer le stockage de téléchargement de fichiers : solution de secours SQL pour le développement, Jami Studio ou fournisseurs personnalisés pour la production."
---
...
2. **Fournisseur Jami Studio** — intégré, s'active automatiquement lorsque Jami Studio est connecté
...
## Hébergement Jami Studio {#builder-hosting}

Lorsque votre application est connectée à Jami Studio, les téléchargements de fichiers sont automatiquement acheminés vers l'hébergement d'actifs de Jami Studio. Les fichiers sont servis à partir d'un CDN sans aucune configuration nécessaire. Il s'agit de la configuration de production recommandée.
