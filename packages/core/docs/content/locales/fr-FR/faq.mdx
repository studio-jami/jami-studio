...
Si vous préférez ne rien gérer de tout cela, la version hébergée sur `agent-native.com` (exploitée par Jami Studio) regroupe l'inférence et l'hébergement dans un forfait par siège.
