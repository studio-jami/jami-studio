...
Démo en direct : [mail.jami.studio](https://mail.jami.studio).

> **Google peut afficher un avertissement :** La démo hébergée utilise l'application Google partagée de Jami Studio pour l'accès à Gmail. Google peut donc vous demander de confirmer avant de continuer. Exécutez localement pour utiliser votre propre client Google OAuth.
...
- [**Actions**](/docs/actions) — le système d’actions appelé par le chat, les raccourcis et les automatisations
