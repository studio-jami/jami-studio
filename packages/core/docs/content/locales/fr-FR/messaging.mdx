...
Information → Display Information**, chargez l’icône Jami Studio afin que le
...
vérifié de l’organisation Jami Studio ou une identité Slack déjà associée.
