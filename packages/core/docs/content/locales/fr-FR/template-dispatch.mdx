...
Démo en direct : [dispatch.jami.studio](https://dispatch.jami.studio).
...
- **Exposer un connecteur MCP.** Ajouter
  `https://dispatch.jami.studio/_agent-native/mcp` dans Claude, ChatGPT,
...
1. Ouvrez **Paramètres**.
2. Dans **LLM**, connectez Jami Studio ou ajoutez votre propre clé de fournisseur telle que `ANTHROPIC_API_KEY`.
