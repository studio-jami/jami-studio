...
### Jami Studio : Édition visuelle en production {#visual-editing-in-production}

[Jami Studio](https://www.jami.studio) résout ce problème en fournissant un environnement cloud géré dans lequel l'agent conserve la possibilité de modifier le UI de votre application en production. Connectez votre dépôt à Jami Studio et demandez directement les modifications de UI – aucun redéploiement n'est nécessaire.

**Comment ça marche :**

1. Connectez votre dépôt natif d'agent à Jami Studio
2. Jami Studio fournit un cadre cloud avec l'agent, l'édition visuelle et la collaboration en temps réel
...
- [**Frames**](/docs/frames) — le panneau d’agent intégré face au cadre cloud de Jami Studio pour les modifications de l’UI en production
