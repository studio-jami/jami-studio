...
Comment fonctionnent les applications natives pour agents : principes et architecture. Cette page est le contrat ; pour la vision et les arguments en faveur de la construction de cette façon, voir [What Is Jami?](/docs/what-is-jami).
...
Un _frame_ est l'environnement qui héberge l'agent à côté de votre application ; localement, il s'agit du panneau intégré ; dans le cloud, c'est la surface gérée de Jami Studio. Voir [Frames](/docs/frames).
...
- **Panneau d'agent intégré** — Chat et terminal CLI en option intégrés à chaque application. Prend en charge le code Claude, Codex, Gemini, OpenCode et Jami Studio. Fonctionne localement. Gratuit et open source.
...
- [**What Is Jami?**](/docs/what-is-jami) — la vision et la philosophie qui sous-tendent ces règles
