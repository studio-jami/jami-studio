...
> endroit. Pour une personnalisation plus poussée, demandez à l'agent de
> modifier le code source du modèle. La personnalisation complète du code est
> une capacité fondamentale d'Agent Native ; les extensions constituent la
> couche rapide, sans déploiement.
