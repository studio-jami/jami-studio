...
- **Le connecteur Plan MCP** — enregistré auprès de l'application hébergée sur `https://plan.jami.studio` (point de terminaison MCP `https://plan.jami.studio/mcp`, nom de serveur `plan`).
