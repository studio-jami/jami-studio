---
title: "Qu'est-ce que Jami Studio ?"
...
Jami Studio offre à chaque utilisateur la même couche de personnalisation, sans jamais quitter l'application. Chaque application est livrée avec un **espace de travail** personnel dans lequel vous (ou n'importe quel membre de votre équipe) pouvez :
...
1. Choisissez un modèle sur [jami.studio/templates](/templates)
2. Utilisez-le immédiatement en tant qu'application hébergée (par exemple mail.jami.studio)
...
5. Déployez votre fork sur votre propre domaine — ou restez sur jami.studio
