...
Le Web public des agents permet aux agents d'explorer, de lire, de citer et d'appeler facilement les routes Jami Studio publiques. L’objectif n’est pas de rendre public chaque point de terminaison d’une application. L'objectif est de publier une surface publique propre pour les pages déjà publiques, tout en conservant l'accès aux données privées et aux outils derrière des contrôles explicites.
