---
title: "Chat natif UI"
description: "Renduurs de chat natifs déclarés par action, sorties DataTable/DataChart réutilisables et manière dont les environnements d'exécution de l'agent BYO doivent se connecter au chat Jami Studio."
---
...
diffusez des événements normalisés dans la conversation UI de Jami Studio tout en conservant
...
<Diagram id="doc-block-5i7siq" title="Le runtime BYO conserve le shell de discussion Jami Studio" summary={"Votre agent externe diffuse des événements normalisés via un connecteur ; Jami Studio conserve le compositeur, la transcription, les fiches outils, les approbations et les widgets natifs."}>
...
Lorsque vous souhaitez que le transport Jami Studio intégré soit un objet d'exécution, utilisez :
...
possède l'intégralité de la transcription externe et ne souhaite que le compositeur de Jami Studio
champ.
