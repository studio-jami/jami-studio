...
description: "Localisez les applications Jami Studio avec des catalogues de paramètres régionaux partagés, un sélecteur de langue, une langue de secours du navigateur et un contenu de documents prenant en compte les paramètres régionaux."
---

# Internationalisation

Les applications Jami Studio peuvent localiser le framework et le modèle UI via le partage
