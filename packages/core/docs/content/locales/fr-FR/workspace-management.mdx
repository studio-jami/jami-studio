...
Tous ceux qui ont besoin d'apporter des modifications ne sont pas à l'aise avec git. [Jami Studio](https://www.jami.studio) prend en charge un modèle de branchement visuel qui correspond aux branches Git sous le capot – utile pour les modifications de contenu et de copie, les ajustements de mise en page, les itérations de conception et les tests A/B sans environnement de développement.
