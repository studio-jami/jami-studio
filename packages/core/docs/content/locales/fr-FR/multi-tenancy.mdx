...
- [**Multi-App Workspace**](/docs/multi-app-workspace) — hébergement de plusieurs applications Jami Studio dans un monorepo avec authentification partagée et RBAC
