---
title: "用戶端"
description: "用於 Jami Studio 應用程式的 React 掛鉤和實用程式：sendToAgentChat、可選代理聊天脈絡狀態、useDbSync、useAgentChatGenerate 和 cn。"
---

# 用戶端

`@agent-native/core` 為 Jami Studio 應用程式的瀏覽器端提供 React 掛鉤和實用程式。
