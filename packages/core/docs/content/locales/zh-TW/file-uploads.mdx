---
title: "檔案上傳"
description: "設定檔案上傳儲存 - 用於開發的 SQL 後備、Jami Studio 或用於正式環境的自訂提供者。"
---
...
2. **Jami Studio 提供者** — 內建，連線 Jami Studio 時自動啟用
...
## Jami Studio 託管 {#builder-hosting}

當您的應用連線到 Jami Studio 時，檔案上傳會自動路由到 Jami Studio 的資產託管。檔案由 CDN 提供，無需設定。這是推薦的正式環境設定。
