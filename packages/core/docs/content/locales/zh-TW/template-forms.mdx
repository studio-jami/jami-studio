---
title: "表格"
description: "Jami Studio 表單生成器 - 透過自然語言和視覺化編輯器建立、編輯、發布和路由表單提交。"
---

# 表格

Forms 是一個 Jami Studio 表單建置器。描述您想要的表單，在編輯器中對其進行完善，然後發布一個公開表單，將提交內容儲存在您自己的 SQL 資料庫中。
...
線上示範：[forms.jami.studio](https://forms.jami.studio)。
