...
Jami Studio Apps verwenden unter der Haube [Nitro](https://nitro.build), was bedeutet, dass Sie sie ohne Konfigurationsänderungen auf jeder Plattform bereitstellen können – legen Sie einfach eine Voreinstellung fest.
...
Eine der Kernfunktionen von Jami Studio besteht darin, dass der Agent den Quellcode Ihrer App ändern kann – Komponenten, Routen, Stile usw. Während der lokalen Entwicklung funktioniert dies reibungslos, da der Agent vollen Zugriff auf das Dateisystem hat.
...
### Jami Studio: Visuelle Bearbeitung in der Produktion {#visual-editing-in-production}

[Jami Studio](https://www.jami.studio) löst dieses Problem durch die Bereitstellung einer verwalteten Cloud-Umgebung, in der der Agent die Möglichkeit behält, den UI Ihrer App in der Produktion zu ändern. Verbinden Sie Ihr Repo mit Jami Studio und fordern Sie direkt UI-Änderungen an – keine erneute Bereitstellung erforderlich.

**So funktioniert es:**

1. Verbinden Sie Ihr agentennatives Repo mit Jami Studio
2. Jami Studio bietet einen Cloud-Frame mit dem Agenten, visueller Bearbeitung und Zusammenarbeit in Echtzeit
...
- [**Frames**](/docs/frames) — Das eingebettete Agent-Panel gegenüber dem Cloud-Frame von Jami Studio für UI-Änderungen in der Produktion
