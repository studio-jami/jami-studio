...
Nicht jeder, der Änderungen vornehmen muss, ist mit Git vertraut. [Jami Studio](https://www.builder.io) unterstützt ein visuelles Verzweigungsmodell, das Git-Zweigen unter der Haube zuordnet – nützlich für Inhalts- und Textänderungen, Layoutanpassungen, Designiterationen und A/B-Tests ohne Entwicklungsumgebung.
