...
Nicht jeder, der Änderungen vornehmen muss, ist mit Git vertraut. [Jami Studio](https://www.jami.studio) unterstützt ein visuelles Verzweigungsmodell, das Git-Zweigen unter der Haube zuordnet – nützlich für Inhalts- und Textänderungen, Layoutanpassungen, Designiterationen und A/B-Tests ohne Entwicklungsumgebung.
...
Jami Studio Arbeitsbereiche verfügen oft über mehrere KI-Agenten, die gleichzeitig im selben Zweig arbeiten. Dies ist beabsichtigt – die Agenten teilen sich einen Zweig und pushen unabhängig voneinander.
