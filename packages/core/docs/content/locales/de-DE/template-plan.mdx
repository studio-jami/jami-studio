...
`https://plan.jami.studio/mcp` – siehe [MCP Clients](/docs/mcp-clients) für kundenspezifische Einrichtung.
...
Der gehostete Plan-Connector befindet sich unter `https://plan.jami.studio/mcp`.
