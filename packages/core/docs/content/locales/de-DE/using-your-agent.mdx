...
Die entscheidende Idee hinter agent-native ist, dass der Agent und der UI **gleichberechtigte Partner** sind – siehe [What Is Jami?](/docs/what-is-jami) für das Warum. In diesem Abschnitt geht es um die andere Hälfte dieses Versprechens: Wie es sich anfühlt, tatsächlich mit dem Agenten zu arbeiten, sobald er neben Ihrer App angedockt ist.
...
**Stimme.** Der Komponist hat ein Mikrofon. Diktieren Sie eine Anfrage, anstatt sie einzugeben. Die Anbieteroptionen reichen von der gehosteten Transkription von Jami Studio über Bring-Your-Own-Key bis hin zu einem Browser-Fallback.
