...
> kein Slot vorhanden ist. Für tiefere Anpassungen bitten Sie den Agenten, den
> Quellcode der Vorlage zu bearbeiten. Die vollständige Anpassbarkeit des Codes
> ist eine Kernfunktion von Agent Native; Erweiterungen sind die schnelle Ebene
> ohne Bereitstellung.
