...
- **Optische Feinabstimmung.** Bearbeiten Sie Beschriftungen, Platzhalter, erforderlichen Status, Optionen und Feldreihenfolge im Jami Studio UI, wenn Sie eine direkte Steuerung wünschen.
...
2. **Im Editor verfeinern.** Beschriftungen, Validierung, Auswahlmöglichkeiten und Reihenfolge anpassen in
   der visuelle Jami Studio, wenn die direkte Bearbeitung schneller ist.
...
- [**Actions**](/docs/actions) – das Aktionssystem, das den Jami Studio antreibt
