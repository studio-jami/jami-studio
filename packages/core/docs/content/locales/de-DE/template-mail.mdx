...
> **Google zeigt möglicherweise eine Warnung an:** Die gehostete Demo nutzt die freigegebene Google-App von Jami Studio für den Gmail-Zugriff, daher bittet Google Sie möglicherweise um eine Bestätigung, bevor Sie fortfahren. Lokal ausführen, um Ihren eigenen Google OAuth-Client zu verwenden.
