...
Jami Studio umfasst lokale Entwicklungsschalter für gängige stdio MCP-Server.
...
Jami Studio startet immer; Eine defekte MCP-Konfiguration bedeutet nur weniger Werkzeuge.
