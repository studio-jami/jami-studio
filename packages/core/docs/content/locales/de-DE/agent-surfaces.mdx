...
description: "Verwenden Sie Jami Studio kopflos, als Rich-Chat, in einer vorhandenen App oder als vollständig agentennative Anwendung."
search: "Headless Agent Rich Chat, vollständige App BYO Agent Runtime AgentChatRuntime Embed actions MCP A2A HTTP CLI"
---

# Agentenoberflächen

Jami Studio ist bewusst zusammensetzbar. Sie können den Agenten ohne großen Aufwand verwenden UI,
...
| **Rich-Chat auf Jami Studio**  | Sie möchten einen eigenständigen oder eingebetteten Chat, der durch die integrierte Agentenschleife unterstützt wird.                      | [Chat template](/docs/template-chat), `<AgentChatSurface>`, `<AssistantChat>`               |
| **Rich-Chat auf Ihrem Agenten** | Sie haben den Agent woanders erstellt und möchten den Verfassenr, das Transkript, die Toolkarten und die nativen Widgets von Jami Studio. | `AgentChatRuntime`, `<AssistantChat runtime={runtime}>`                                     |
...
ein anderer Agent oder ein vorhandenes Produkt, das Jami Studio aufruft.
...
Code, Codex, Pi, Cursor, Mastra oder ähnliche Laufzeiten innerhalb einer Jami Studio-App.
...
## Rich-Chat auf Jami Studio {#rich-chat}
...
Laufzeit und Sie möchten Jami Studios Chat-Oberfläche darum herum. `AgentChatRuntime` ist der
Grenze: Ihre Laufzeit streamt normalisierte Ereignisse und Jami Studio rendert die
...
nicht der Endbenutzer-App-Chat oder A2A-Transport, und Jami Studio derzeit nicht
...
Das Server-Plugin stellt Jami Studio-Routen in Ihre Host-App ein und löst sie auf
...
<Diagram id="doc-block-9hoj3n" title={"Wie der Sidecar eine Brücke zu einer Host-App herstellt"} summary={"Das Plugin mountet Jami Studio-Routen serverseitig; Der Sidecar React streamt den Seitenkontext ein und Hostbefehle aus."}>
...
<div class="diagram-sidecar">
  ...
  <div class="diagram-panel accent-panel">
    ...
    <div class="diagram-box" data-rough>
      Jami Studio-Routen<br /><small class="diagram-muted"
...
| „Ich möchte den Agenten des Frameworks, aber Chat sollte der Haupt-UI sein.“            | Rich-Chat auf Jami Studio   |
...
- [**A2A Protocol**](/docs/a2a-protocol) – Agenten aus anderen Jami Studio-Apps aufrufen
