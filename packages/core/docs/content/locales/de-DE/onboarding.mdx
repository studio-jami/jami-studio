...
- **Anschließen einer KI-Engine** (erforderlich) – der einzige obligatorische Schritt. Verbinden
  Jami Studio für ein mit einem Klick verwaltetes Gateway, oder öffnen Sie den sekundären Anbieterschlüssel
...
| ---------- | ------------ | -------------------------------------------------------- |
| `llm`      | Ja           | Jami Studio-Verbindung oder ein Provider-LLM-Schlüssel   |
