...
Das musst du nicht. Jede Beispiel-App ist auch als gehostete App auf `jami.studio` – `mail.jami.studio`, `calendar.jami.studio` usw. verfügbar. Nutzen Sie die gehostete Version kostenlos oder kostenpflichtig; Fork nur, wenn Sie etwas ändern möchten, das die gehostete Version nicht offenlegt.
