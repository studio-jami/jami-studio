...
kann auch von Codex, Claude Code, dem Jami Studio-Sidebar-Agenten oder einem normalen bearbeitet werden
Herausgeber.
...
oder Jami Studio Desktop Bridge macht sie verfügbar. Wenn keine Bridge läuft, wird der Skill
...
einfacher Zugriff auf gehostete Browserordner. Wenn Sie `content.jami.studio` öffnen,
...
Inhalte lokal oder verwenden Sie Jami Studio Desktop, damit die vertrauenswürdige lokale Bridge dies tun kann
