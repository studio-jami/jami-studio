...
- **Codemodus** – fügt die gemeinsam genutzten Codierungstools hinzu (`bash`, `read`, `edit`, `write`)
  ...
  Dialog, der erklärt, dass Codeänderungen Jami Studio Desktop oder Jami Studio erfordern;
...
[Jami Studio](https://www.jami.studio) stellt einen verwalteten Frame bereit, der das hostet
