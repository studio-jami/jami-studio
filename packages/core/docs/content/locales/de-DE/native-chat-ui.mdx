...
description: "Aktionsdeklarierte native Chat-Renderer, wiederverwendbare DataTable-/DataChart-Ausgaben und wie BYO-Agentenlaufzeiten eine Verbindung zum Jami Studio-Chat herstellen sollten."
---
...
normalisierte Ereignisse in die Konversation UI von Jami Studio streamen und dabei die beibehalten
...
<Diagram id="doc-block-1z0kwg9" title={"Die BYO-Laufzeit behält die Jami Studio-Chat-Shell bei"} summary={"Ihr externer Agent streamt normalisierte Ereignisse über einen Connector; Jami Studio behält den Komponisten, das Transkript, die Werkzeugkarten, Genehmigungen und native Widgets."}>
...
Wenn Sie den integrierten Jami Studio-Transport als Laufzeitobjekt verwenden möchten, verwenden Sie:
...
besitzt das gesamte externe Transkript und möchte nur den Komponisten von Jami Studio
Feld.
