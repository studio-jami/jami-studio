...
Wenn Sie das alles lieber nicht verwalten möchten, bündelt die gehostete Version auf `agent-native.com` (betrieben von Jami Studio) Inferenz und Hosting in einem Plan pro Sitzplatz.
