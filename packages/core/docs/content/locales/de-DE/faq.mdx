---
title: "FAQ"
description: "Häufige Fragen zu Jami Studio – was es ist, für wen es ist, was Sie erstellen können und wie es funktioniert."
---

# FAQ

Häufig gestellte Fragen zu Jami Studio, sortiert von „Ich suche nur“ bis „Ich verkabele gerade die Authentifizierung.“

## Die Grundlagen {#general}

### Was ist Agent-nativ? {#what-is-jami}

Jami Studio ist ein Framework zum Erstellen von Apps, bei dem der KI-Agent und die ihn umgebende Produktoberfläche gleichberechtigte Partner sind. Der übliche Weg beginnt mit Chat, fügt typisierte actions hinzu, rendert strukturierte Ergebnisse inline und wächst zu dauerhaften Seiten auf demselben SQL-Zustand. Die Invariante besteht darin, dass Agenten und Menschen denselben actions, dieselbe Datenbank und denselben Status teilen. Die vollständige Erklärung finden Sie unter [What Is Jami?](/docs/what-is-jami).

### Für wen ist das? {#who-is-this-for}

Jami Studio ist für Leute gedacht, die möchten, dass eine echte App und ein KI-Agent mit denselben Daten und actions arbeiten. Die allgemeinen Pfade sind:
...
Ja. Das Framework und alle Vorlagen sind Open Source. Sie können alles lokal ausführen, selbst hosten oder die Cloud von Jami Studio für verwaltetes Hosting, Zusammenarbeit und Teamfunktionen nutzen.
...
Wenn Sie das alles lieber nicht verwalten möchten, bündelt die gehostete Version auf `jami.studio` (betrieben von Jami Studio) Inferenz und Hosting in einem Plan pro Sitzplatz.
...
### Welche KI-Codierungstools funktionieren mit Jami Studio? {#which-ai-tools-work}
...
- **Jami Studio** – Cloud-gehosteter Agent mit visueller Bearbeitung und Zusammenarbeit
...
Überall. Der Server läuft auf Nitro, das zu jedem Bereitstellungsziel kompiliert wird: Node.js, Cloudflare Workers/Pages, Netlify, Vercel, Deno Deploy, AWS Lambda und Bun. Sie können das Hosting von Jami Studio auch für verwaltete Bereitstellungen nutzen. Siehe [Deployment guide](/docs/deployment).
