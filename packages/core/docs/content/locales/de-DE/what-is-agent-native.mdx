...
Das ist die Erfahrung, für die Jami Studio entwickelt wurde. Hier erfahren Sie, warum die meisten Produkte dort nicht ankommen.
...
Jami Studio bietet jedem Benutzer die gleiche Anpassungsebene – ohne die App jemals zu verlassen. Jede App verfügt über einen persönlichen **Arbeitsbereich**, in dem Sie (oder jeder in Ihrem Team) Folgendes tun kann:
...
Jami Studio ist nicht nur für Entwickler. Da der Agent den eigenen Code der App bearbeiten kann, ist die Weiterentwicklung einer App keine reine Entwickleraktivität mehr:
...
1. Wählen Sie eine Vorlage auf [jami.studio/templates](/templates)
2. Sofort als gehostete App verwenden (z. B. mail.jami.studio)
...
5. Stellen Sie Ihren Fork in Ihrer eigenen Domain bereit – oder bleiben Sie auf jami.studio
...
Jami Studio Apps können miteinander kommunizieren. In der E-Mail-App können Sie den Analyseagenten markieren, um Daten abzufragen und das Ergebnis in einen E-Mail-Entwurf aufzunehmen. Die Agenten ermitteln, welche anderen Agenten verfügbar sind, geben die Arbeit untereinander ab und zeigen die Ergebnisse in der UI an, in der Sie sich bereits befinden.
