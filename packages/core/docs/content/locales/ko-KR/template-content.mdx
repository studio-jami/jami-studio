...
라이브 데모: [content.jami.studio](https://content.jami.studio).
...
및 `resources/`. 로컬 콘텐츠 앱, Jami Studio 데스크톱 또는 신뢰할 수 있는 경우
...
읽고 쓰기 위한 Jami Studio 데스크탑 내부의 보호된 기본 폴더 브리지
...
모드 및 Jami Studio 데스크톱, Finder에 표시는
...
콘텐츠를 로컬로 사용하거나 Jami Studio 데스크탑을 사용하여 선택한 작업공간 경로를 사용할 수 있습니다.
