---
title: "파일 업로드"
description: "파일 업로드 저장소 구성 - 개발용 SQL 대체, 프로덕션용 Jami Studio 또는 사용자 지정 공급자"
---
...
2. **Jami Studio 공급자** — 내장, Jami Studio가 연결되면 자동으로 활성화됨
...
## Jami Studio 호스팅 {#builder-hosting}

앱이 Jami Studio에 연결되면 파일 업로드가 자동으로 Jami Studio의 자산 호스팅으로 라우팅됩니다. 파일은 구성이 필요 없이 CDN에서 제공됩니다. 이는 권장되는 제작 설정입니다.
