...
> 참고: 베어 `npx skills@latest add Jami Studio/agent-native --skill visual-plan`(Vercel/open Skills CLI)는 **지침만** 설치하며 MCP 커넥터를 등록하지 않습니다. 커넥터도 배선하려면 위의 Agent-Native CLI를 사용하세요.
