...
- **Plan MCP 커넥터** — `https://plan.jami.studio`(MCP 엔드포인트 `https://plan.jami.studio/mcp`, 서버 이름 `plan`)에서 호스팅된 앱에 대해 등록되었습니다.
