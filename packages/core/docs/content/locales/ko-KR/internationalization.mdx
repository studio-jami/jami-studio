---
title: "국제화"
description: "공유 로케일 카탈로그, 언어 선택기, 브라우저 언어 대체 및 로케일 인식 문서 콘텐츠를 사용하여 Jami Studio 앱을 현지화합니다."
---

# 국제화

Jami Studio 앱은 공유를 통해 프레임워크 및 템플릿 UI를 현지화할 수 있습니다.
...
활성 로캘을 다운로드합니다. 지원되는 로캘 코드는 `en-US`, `zh-CN`, `zh-TW`,
