...
꼭 그럴 필요는 없습니다. 모든 예제 앱은 `jami.studio`(`mail.jami.studio`, `calendar.jami.studio` 등)에서 호스팅된 앱으로도 사용할 수 있습니다. 무료 또는 유료로 호스팅 버전을 사용하세요. 호스팅 버전이 공개하지 않는 내용을 변경하려는 경우에만 포크하세요.
