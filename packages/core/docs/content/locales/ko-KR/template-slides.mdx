...
- **AI로 이미지를 생성합니다.** 히어로 이미지, 제품 모형, 일러스트레이션은 자산에 위임하는 것이 바람직하며 Jami Studio 관리 이미지 생성을 통해 일단 배포되면 현재 대체 수단으로 공급자 키를 직접 사용할 수 있습니다.
...
라이브 데모: [slides.jami.studio](https://slides.jami.studio).
