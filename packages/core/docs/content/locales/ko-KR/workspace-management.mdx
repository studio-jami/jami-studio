...
변경이 필요한 모든 사람이 git에 익숙하지는 않습니다. [Jami Studio](https://www.builder.io)는 내부적으로 git 분기에 매핑되는 시각적 분기 모델을 지원합니다. 이는 개발 환경 없이 콘텐츠 및 복사 변경, 레이아웃 조정, 디자인 반복 및 A/B 테스트에 유용합니다.
