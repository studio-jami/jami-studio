...
description: "Localize aplicativos Jami Studio com catálogos de localidade compartilhados, um seletor de idioma, substituto de idioma do navegador e conteúdo de documentos com reconhecimento de localidade."
---

# Internacionalização

Os aplicativos Jami Studio podem localizar a estrutura e o modelo UI por meio do compartilhamento
...
baixe a localidade ativa. Os códigos de localidade suportados são `en-US`, `zh-CN`, `zh-TW`,
