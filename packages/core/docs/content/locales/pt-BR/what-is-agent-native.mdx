...
O Jami Studio oferece a todos os usuários a mesma camada de personalização, sem nunca sair do aplicativo. Cada aplicativo vem com um **espaço de trabalho** pessoal onde você (ou qualquer pessoa da sua equipe) pode:
...
1. Escolha um modelo em [jami.studio/templates](/templates)
2. Use-o imediatamente como um aplicativo hospedado (por exemplo, mail.jami.studio)
...
5. Implante seu fork em seu próprio domínio — ou permaneça em jami.studio
