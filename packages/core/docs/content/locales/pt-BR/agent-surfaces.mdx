...
description: "Use Jami Studio sem controle, como bate-papo avançado, dentro de um aplicativo existente ou como um aplicativo completo nativo do agente."
...
Jami Studio é deliberadamente combinável. Você pode usar o agente sem muito UI,
...
| **Bate-papo rico em Jami Studio**    | Você deseja um bate-papo independente ou incorporado, apoiado pelo loop de agente integrado.                                             | [Chat template](/docs/template-chat), `<AgentChatSurface>`, `<AssistantChat>`               |
| **Bate-papo avançado com seu agente** | Você criou o agente em outro lugar e deseja o compositor, a transcrição, os cartões de ferramentas e os widgets nativos do Jami Studio. | `AgentChatRuntime`, `<AssistantChat runtime={runtime}>`                                     |
...
outro agente ou um produto existente ligando para Jami Studio.
...
Código, Codex, Pi, Cursor, Mastra ou tempos de execução semelhantes dentro de um aplicativo Jami Studio.
...
## Bate-papo rico em Jami Studio {#rich-chat}
...
tempo de execução e você deseja o bate-papo do Jami Studio UI em torno dele. `AgentChatRuntime` é o
limite: seu tempo de execução transmite eventos normalizados e Jami Studio renderiza o
...
não é o bate-papo do aplicativo do usuário final ou o transporte A2A, e Jami Studio atualmente não
...
O plug-in do servidor monta rotas Jami Studio em seu aplicativo host e resolve
...
<Diagram id="doc-block-dejs3c" title="Como o sidecar faz a ponte para um aplicativo host" summary={"O plugin monta rotas Jami Studio no lado do servidor; o sidecar React transmite o contexto da página e sai dos comandos do host."}>
...
<div class="diagram-sidecar">
  ...
  <div class="diagram-panel accent-panel">
    ...
    <div class="diagram-box" data-rough>
      rotas Jami Studio<br /><small class="diagram-muted"
...
| "Quero o agente do framework, mas o chat deve ser o principal UI."         | Bate-papo rico em Jami Studio    |
...
- [**A2A Protocol**](/docs/a2a-protocol) — chame agentes de outros aplicativos Jami Studio
