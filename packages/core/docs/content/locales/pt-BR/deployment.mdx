...
### Jami Studio: edição visual em produção {#visual-editing-in-production}
...
- [**Frames**](/docs/frames) — o painel de agente incorporado em comparação com o quadro de nuvem da Jami Studio para edições da UI de produção
