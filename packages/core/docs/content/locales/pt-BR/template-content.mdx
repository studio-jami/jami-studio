...
Demonstração ao vivo: [content.jami.studio](https://content.jami.studio).
...
e `resources/`. Quando um aplicativo de conteúdo local, Jami Studio Desktop ou confiável
...
ponte de pasta nativa protegida dentro do Jami Studio Desktop, para leitura e gravação
...
modo e Jami Studio Desktop, e Reveal no Finder estão disponíveis através do
...
Conteúdo localmente ou use o Jami Studio Desktop para que o caminho do espaço de trabalho selecionado possa
