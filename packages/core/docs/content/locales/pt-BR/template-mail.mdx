...
Demonstração ao vivo: [mail.jami.studio](https://mail.jami.studio).

> **O Google pode mostrar um aviso:** A demonstração hospedada usa o aplicativo compartilhado do Google de Jami Studio para acesso ao Gmail, portanto, o Google pode solicitar que você confirme antes de continuar. Execute localmente para usar seu próprio cliente Google OAuth.
