...
A web pública do agente torna as rotas Jami Studio públicas fáceis para os agentes rastrearem, lerem, citarem e ligarem. O objetivo não é tornar públicos todos os endpoints do aplicativo. O objetivo é publicar uma superfície pública limpa para páginas que já são públicas, mantendo dados privados e acesso a ferramentas sob controles explícitos.
