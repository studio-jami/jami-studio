...
Demonstração ao vivo: [dispatch.jami.studio](https://dispatch.jami.studio).
...
- **Exponha um conector MCP.** Adicione
  `https://dispatch.jami.studio/_agent-native/mcp` em Claude, ChatGPT,
...
2. Em **LLM**, conecte Jami Studio ou adicione sua própria chave de provedor, como `ANTHROPIC_API_KEY`.
