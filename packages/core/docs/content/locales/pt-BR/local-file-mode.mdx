...
também pode ser editado por Codex, Claude Code, agente da barra lateral Jami Studio ou um normal
editor.
...
ou Jami Studio Desktop bridge os expõe. Se nenhuma ponte estiver funcionando, a habilidade
...
acesso simples à pasta do navegador hospedado. Se você abrir `content.jami.studio`,
...
Conteúdo localmente ou use o Jami Studio Desktop para que a ponte local confiável possa
