...
Mantenha Jami Studio CLI como caminho de documentos padrão para agentes locais porque
...
lugar. Jami Studio skills recentemente copiado inclui um `agent-native-skill.json`
marcador para que a saída de status futuro possa identificar a origem e o hash.

Aplicativos e espaços de trabalho Jami Studio gerados também incluem estrutura fornecida
