...
A ideia definidora por trás do agente nativo é que o agente e o UI são **parceiros iguais** — consulte [What Is Jami?](/docs/what-is-jami) para saber o porquê. Esta seção trata da outra metade dessa promessa: como é realmente trabalhar com o agente quando ele está acoplado ao seu aplicativo.
...
**Voz.** O compositor possui um microfone. Dite uma solicitação em vez de digitá-la, com opções de provedor que vão desde a transcrição hospedada do Jami Studio até trazer sua própria chave para um substituto do navegador.
