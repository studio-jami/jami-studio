...
- **El conector del plan MCP**: registrado en la aplicación alojada en `https://plan.jami.studio` (extremo MCP `https://plan.jami.studio/mcp`, nombre de servidor `plan`).
