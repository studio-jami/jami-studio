...
- **Genere imágenes con IA.** Imágenes destacadas, maquetas de productos e ilustraciones, preferiblemente delegadas a Recursos, con la generación de imágenes administrada por Jami Studio lista para habilitar claves de proveedor directas y una vez implementadas como alternativa actual.
...
Demostración en vivo: [slides.jami.studio](https://slides.jami.studio).
