...
| Alojado propio (`*.jami.studio`)                   | Espacio de nombres aislado por aplicación (cada una tiene su propia base de datos de autenticación); `COOKIE_DOMAIN=.jami.studio` se ignora de forma predeterminada |
