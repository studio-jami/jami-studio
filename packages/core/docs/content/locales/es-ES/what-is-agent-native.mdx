...
1. Elija una plantilla en [jami.studio/templates](/templates)
2. Úselo inmediatamente como una aplicación alojada (por ejemplo, mail.jami.studio)
...
5. Implemente su bifurcación en su propio dominio o permanezca en jami.studio
