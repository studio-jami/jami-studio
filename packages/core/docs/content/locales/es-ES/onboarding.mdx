...
- **Conectar un motor de IA** (obligatorio): el único paso obligatorio. Conectar
  Jami Studio para una puerta de enlace administrada con un solo clic o abra la clave del proveedor secundario
...
| -------------- | ----------- | ----------------------------------------------------------- |
| `llm`          | sí          | Conexión Jami Studio o clave de proveedor LLM                   |
