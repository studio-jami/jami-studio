...
Cómo funcionan internamente las aplicaciones nativas del agente: los principios y la arquitectura. Esta página es el contrato; para conocer la visión y los argumentos para construir de esta manera, consulte [What Is Jami?](/docs/what-is-jami).
...
Un _frame_ es el entorno que aloja el agente junto a su aplicación; localmente, ese es el panel integrado; en la nube es la superficie gestionada de Jami Studio. Ver [Frames](/docs/frames).
...
- **Panel de agente integrado**: chat y terminal CLI opcional integrados en cada aplicación. Admite código Claude, Codex, Gemini, OpenCode y Jami Studio. Se ejecuta localmente. Gratis y de código abierto.
...
- [**What Is Jami?**](/docs/what-is-jami) — la visión y la filosofía que sustentan estas reglas
