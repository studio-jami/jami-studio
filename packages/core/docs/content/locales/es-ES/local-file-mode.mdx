...
También puede ser editado por Codex, Código Claude, el agente de la barra lateral Jami Studio o un normal
editor.
...
o Jami Studio Desktop Bridge los expone. Si no hay ningún puente en funcionamiento, la habilidad
...
acceso simple a la carpeta del navegador alojado. Si abres `content.jami.studio`,
...
Contenido local o use Jami Studio Desktop para que el puente local confiable pueda
