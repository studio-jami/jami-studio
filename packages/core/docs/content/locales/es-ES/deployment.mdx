...
### Jami Studio: Edición visual en producción {#visual-editing-in-production}

[Jami Studio](https://www.jami.studio) resuelve este problema proporcionando un entorno de nube administrado donde el agente conserva la capacidad de modificar el UI de su aplicación en producción. Conecte su repositorio a Jami Studio y solicite los cambios de UI directamente, sin necesidad de volver a implementarlo.

**Cómo funciona:**

1. Conecte su repositorio nativo del agente a Jami Studio
2. Jami Studio proporciona un marco en la nube con el agente, edición visual y colaboración en tiempo real
...
- [**Frames**](/docs/frames) — el panel de agente integrado frente al marco en la nube de Jami Studio para editar la UI de producción
