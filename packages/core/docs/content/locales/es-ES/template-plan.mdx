...
`https://plan.jami.studio/mcp`: consulte [MCP Clients](/docs/mcp-clients) para conocer la configuración específica del cliente.
...
- El modelo de chat predeterminado de la propia aplicación es Sonnet 5; cámbielo
  en cualquier momento en **Configuración**. Haiku es la opción más económica de
  Claude, y Luna es la opción más económica dentro de la familia GPT-5.6.
...
El conector de planes alojado se encuentra en `https://plan.jami.studio/mcp`.
