...
No todos los que necesitan realizar cambios se sienten cómodos con git. [Jami Studio](https://www.jami.studio) admite un modelo de ramificación visual que se asigna a ramas de git internas, lo que resulta útil para cambios de contenido y copia, ajustes de diseño, iteraciones de diseño y pruebas A/B sin un entorno de desarrollo.
