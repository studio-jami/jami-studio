...
→ Display Information**, cargue el icono de Jami Studio para que el selector de
...
verificado de la organización de Jami Studio o de una identidad de Slack ya
