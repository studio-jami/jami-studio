...
description: "Localice aplicaciones Jami Studio con catálogos de configuración regional compartidos, un selector de idioma, respaldo de idioma del navegador y contenido de documentos compatible con la configuración regional."
---

# Internacionalización

Las aplicaciones Jami Studio pueden localizar el marco y la plantilla UI a través del recurso compartido
