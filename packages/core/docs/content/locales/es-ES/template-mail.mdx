...
Demostración en vivo: [mail.jami.studio](https://mail.jami.studio).

> **Google puede mostrar una advertencia:** La demostración alojada utiliza la aplicación compartida de Google de Jami Studio para el acceso a Gmail, por lo que Google puede pedirle que confirme antes de continuar. Ejecútelo localmente para utilizar su propio cliente Google OAuth.
...
- [**Acciones**](/docs/actions) — el sistema de acciones que invocan el chat, los atajos y las automatizaciones
