...
Jami Studio incluye una barra lateral completa, pero la barra lateral no es el contrato. El
...
| `createAgentChatAdapter()`           | `@agent-native/core/client` o `/client/chat` | Necesita el transporte Jami Studio SSE integrado como adaptador de interfaz de usuario asistente de bajo nivel.                            |
...
conversación mientras Jami Studio mantiene el compositor, la transcripción, las tarjetas de herramientas y
