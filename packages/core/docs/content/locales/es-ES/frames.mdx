...
- **Jami Studio marco de nube**: un marco alojado y administrado con colaboración,
...
<div class="diagram-frames">
  ...
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">Marco cloud de Jami Studio</span
...
- **Modo de código**: agrega las herramientas de codificación compartidas (`bash`, `read`, `edit`, `write`)
  ...
  diálogo que explica que los cambios de código necesita Jami Studio Desktop o Jami Studio;
...
<Diagram id="doc-block-14b7eu4" title={"Puerta de solicitud de código"} summary={"Un mensaje escrito con código necesita un marco con capacidad para codificar. Con uno conectado, la solicitud se dirige allí; sin uno, el panel explica que los cambios de código necesitan Desktop o Jami Studio."}>
...
## Marco de nube Jami Studio {#cloud-frame}

[Jami Studio](https://www.jami.studio) proporciona un marco administrado que aloja el
...
Las solicitudes de código del panel integrado se dirigen al marco Jami Studio de la misma manera
