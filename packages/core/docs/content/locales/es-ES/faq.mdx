...
Si prefiere no administrar nada de esto, la versión alojada en `agent-native.com` (operada por Jami Studio) incluye inferencia y alojamiento en un plan por puesto.
