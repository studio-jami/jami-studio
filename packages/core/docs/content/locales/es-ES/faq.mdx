...
### ¿Qué es el agente nativo? {#what-is-jami}

Jami Studio es un marco para crear aplicaciones en las que el agente de IA y la superficie del producto que lo rodea son socios iguales. El camino habitual empieza con chat, añade actions tipadas, renderiza resultados estructurados en línea y crece hacia páginas duraderas sobre el mismo estado SQL. La invariante es que los agentes y los humanos comparten el mismo actions, base de datos y estado. Consulte [What Is Jami?](/docs/what-is-jami) para obtener la explicación completa.
...
Sí. El marco y todas las plantillas son de código abierto. Puede ejecutar todo localmente, autohospedarse o utilizar la nube de Jami Studio para alojamiento administrado, colaboración y funciones de equipo.
...
Si prefiere no administrar nada de esto, la versión alojada en `jami.studio` (operada por Jami Studio) incluye inferencia y alojamiento en un plan por puesto.
...
- **Jami Studio**: agente alojado en la nube con edición visual y colaboración
