...
description: "Utilice Jami Studio sin cabeza, como chat enriquecido, dentro de una aplicación existente o como una aplicación nativa completa del agente."
...
Jami Studio es deliberadamente componible. Puedes utilizar el agente sin mucho UI,
...
| **Chat enriquecido en Jami Studio** | Quiere un chat independiente o integrado respaldado por el bucle de agente integrado.                                                          | [Chat template](/docs/template-chat), `<AgentChatSurface>`, `<AssistantChat>`               |
| **Chat enriquecido con tu agente**   | Creaste el agente en otro lugar y quieres el compositor, la transcripción, las tarjetas de herramientas y los widgets nativos de Jami Studio. | `AgentChatRuntime`, `<AssistantChat runtime={runtime}>`                                     |
...
otro agente o un producto existente llamando a Jami Studio.
...
Código, Codex, Pi, Cursor, Mastra o tiempos de ejecución similares dentro de una aplicación Jami Studio.
...
## Chat enriquecido en Jami Studio {#rich-chat}
...
tiempo de ejecución y desea que el chat UI de Jami Studio lo rodee. `AgentChatRuntime` es el
límite: su tiempo de ejecución transmite eventos normalizados y Jami Studio representa el
...
no es el chat de la aplicación del usuario final ni el transporte A2A, y Jami Studio no lo hace actualmente
...
El complemento del servidor monta rutas Jami Studio en su aplicación host y las resuelve
...
<Diagram id="doc-block-1ap1jtt" title={"Cómo el sidecar se conecta con una aplicación host"} summary={"El complemento monta rutas Jami Studio en el lado del servidor; el sidecar React transmite el contexto de la página y envía los comandos del host."}>
...
<div class="diagram-sidecar">
  ...
  <div class="diagram-panel accent-panel">
    ...
    <div class="diagram-box" data-rough>
      rutas Jami Studio<br /><small class="diagram-muted"
...
| "Quiero el agente del framework, pero el chat debería ser el UI principal." | Chat enriquecido en Jami Studio |
...
- [**A2A Protocol**](/docs/a2a-protocol): llama a agentes desde otras aplicaciones Jami Studio
