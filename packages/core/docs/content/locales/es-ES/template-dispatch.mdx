...
Demostración en vivo: [dispatch.jami.studio](https://dispatch.jami.studio).
...
- **Exponer un conector MCP.** Agregar
  `https://dispatch.jami.studio/_agent-native/mcp` en Claude, ChatGPT,
...
2. En **LLM**, conecte Jami Studio o agregue su propia clave de proveedor, como `ANTHROPIC_API_KEY`.
