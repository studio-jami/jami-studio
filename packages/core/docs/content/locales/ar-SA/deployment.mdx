...
يحتاج كل تطبيق منشور إلى قاعدة بيانات SQL مستمرة. في التطوير المحلي، يعود Jami Studio إلى ملف SQLite في `data/app.db`؛ وهو مناسب لجهازك، ولكنه ليس دائمًا في الحاويات أو المعاينات أو البيئات التي لا تحتوي على خادم حيث يمكن إعادة ضبط نظام الملفات.
...
### Jami Studio: التحرير المرئي في الإنتاج {#visual-editing-in-production}

يقوم [Jami Studio](https://www.jami.studio) بحل هذه المشكلة من خلال توفير بيئة سحابية مُدارة حيث يحتفظ الوكيل بالقدرة على تعديل UI لتطبيقك في الإنتاج. قم بتوصيل الريبو الخاص بك بـ Jami Studio والمطالبة بتغييرات UI مباشرة - لا حاجة لإعادة النشر.

**كيفية العمل:**

1. قم بتوصيل الريبو الأصلي للوكيل الخاص بك إلى Jami Studio
2. يوفر Jami Studio إطارًا سحابيًا مع الوكيل والتحرير المرئي والتعاون في الوقت الفعلي
...
- [**Frames**](/docs/frames) — لوحة الوكيل المضمنة مقارنةً بإطار Jami Studio السحابي لتعديلات واجهة الإنتاج
