...
عرض توضيحي مباشر: [content.jami.studio](https://content.jami.studio).
...
و `resources/`. عندما يكون تطبيق المحتوى المحلي، أو Jami Studio Desktop، أو موثوقًا به
...
جسر المجلد الأصلي المحمي داخل Jami Studio Desktop، للقراءة والكتابة
...
وJami Studio Desktop والكشف في Finder من خلال
...
المحتوى محليًا أو استخدم Jami Studio Desktop حتى يتمكن مسار مساحة العمل المحدد من العمل
