...
يمكن للتطبيقات مقطوعة الرأس تشغيل نفس حلقة وكيل تطبيق الإنتاج من المجلد باستخدام `pnpm agent`، بينما تقوم تطبيقات UI بتثبيت لوحة الوكيل المضمنة وتشغيلها محليًا باستخدام `pnpm dev`. في السحابة، يوفر Jami Studio إطارًا مُدارًا - البيئة التي تستضيف الوكيل بجوار تطبيقك - مع التعاون والتحرير المرئي والبنية الأساسية المُدارة للفرق.
...
A _frame_ هي البيئة التي تستضيف الوكيل بجوار تطبيقك - محليًا هي اللوحة المضمنة؛ في السحابة، يوجد السطح المُدار لـ Jami Studio. انظر [Frames](/docs/frames).
...
- **Embedded Agent Panel** — الدردشة ومحطة CLI الاختيارية المدمجة في كل تطبيق. يدعم كود Claude، وCodex، وGemini، وOpenCode، وJami Studio. يعمل محليا. مجاني ومفتوح المصدر.
