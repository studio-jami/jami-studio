...
زر يقوم بتسليم العمل إلى الوكيل (بدلاً من تشغيل استدعاء `llm()` المضمن - النمط المضاد من [ladder](/docs/what-is-jami#the-ladder)):
...
- **إحضار وقت تشغيل الوكيل الخاص بك.** إذا كان ينبغي على الوكيل الذي أنشأته في مكان آخر
  دعم المحادثة بينما يحتفظ Jami Studio بالملحن والنص والأداة
...
عندما يحتاج UI إلى تشغيل نفس العملية، سيتم تشغيل أداة الوكيل - الدرجة 3 من [ladder](/docs/what-is-jami#rung-three) - استخدم `useActionMutation`:
