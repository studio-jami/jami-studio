...
### ما هو الوكيل الأصلي؟ {#what-is-jami}

Jami Studio هو framework لبناء التطبيقات حيث يكون AI agent وسطح المنتج المحيط به شريكين متساويين. يبدأ المسار المعتاد بالدردشة، ثم يضيف typed actions، ويعرض نتائج منظمة inline، ثم ينمو إلى صفحات دائمة فوق نفس SQL state. الثابت هو أن agents والبشر يتشاركون نفس actions وقاعدة البيانات والحالة. راجع [What Is Jami?](/docs/what-is-jami) للحصول على الشرح الكامل.
