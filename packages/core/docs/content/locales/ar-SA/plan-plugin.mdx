...
- **موصل Plan MCP** — مسجل في التطبيق المستضاف على `https://plan.jami.studio` (نقطة نهاية MCP `https://plan.jami.studio/mcp`، اسم الخادم `plan`).
