...
> ملاحظة: يقوم `npx skills@latest add Jami Studio/agent-native --skill visual-plan` (Vercel/open Skills CLI) بتثبيت **التعليمات فقط** - ولا يسجل موصل MCP. استخدم Agent-Native CLI أعلاه عندما تريد توصيل الموصل أيضًا.
