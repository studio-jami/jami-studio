...
يشحن Jami Studio شريطًا جانبيًا كاملاً، لكن الشريط الجانبي ليس العقد.
...
| `createAgentChatAdapter()`           | `@agent-native/core/client` أو `/client/chat` | تحتاج إلى وسيلة نقل Jami Studio SSE المدمجة كمحول مساعد لواجهة المستخدم منخفضة المستوى. |
...
المحادثة بينما يحتفظ Jami Studio بالملحن والنص وبطاقات الأدوات و
