...
<div class="auto-flow">
  ...
  <div class="diagram-card">
    ...
    ><small class="diagram-muted"
      >يتحقق هايكو: &ldquo;ينتهي البريد الإلكتروني بـ @jami.studio&rdquo;</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
> "عندما يحجز شخص ما اجتماعًا باستخدام بريد إلكتروني @jami.studio، أرسل لي رسالة على Slack."
...
**المستخدم:** "عندما يقوم شخص ما بالحجز باستخدام بريد إلكتروني @jami.studio، أرسل لي رسالة على Slack."
