---
title: "مثبت المخطط"
description: "تطبع إضافة Jami Studio وصفة تكامل Markdown منسقة إلى stdout - قم بتوصيلها إلى وكيل الترميز الخاص بك، والذي يطبق التغييرات على الريبو المباشر الخاص بك."
---
