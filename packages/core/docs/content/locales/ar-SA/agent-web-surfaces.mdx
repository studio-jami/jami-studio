...
تجعل شبكة الوكيل العام مسارات Jami Studio العامة سهلة على الوكلاء للزحف إليها وقراءتها والاستشهاد بها والاتصال بها. الهدف ليس جعل نقطة نهاية كل تطبيق عامة. الهدف هو نشر سطح عام نظيف للصفحات العامة بالفعل، مع الاحتفاظ بالبيانات الخاصة والوصول إلى الأدوات خلف ضوابط واضحة.
