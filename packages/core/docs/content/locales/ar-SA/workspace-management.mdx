...
ليس كل من يحتاج إلى إجراء تغييرات يشعر بالارتياح تجاه git. يدعم [Jami Studio](https://www.builder.io) نموذج التفرع المرئي الذي يعين فروع git الموجودة تحت الغطاء - وهو مفيد لتغييرات المحتوى والنسخ، وتعديلات التخطيط، وتكرارات التصميم، واختبار A/B بدون بيئة تطوير.
