...
احتفظ بـ Jami Studio CLI كمسار المستندات الافتراضي للوكلاء المحليين لأنه
أيضًا بتسجيل موصل MCP. `Jami Studio/agent-native` هو GitHub حقيقي
...
المكان. تتضمن Jami Studio skills المنسوخة حديثًا `agent-native-skill.json`
علامة حتى يتمكن إخراج الحالة المستقبلية من تحديد المصدر والتجزئة.

تتضمن تطبيقات ومساحات العمل Jami Studio التي تم إنشاؤها أيضًا إطار العمل المقدم
