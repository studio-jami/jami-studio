---
title: "الخطط المرئية"
description: "تعمل خطط Jami Studio على تحويل خطة وكيل الترميز إلى مستند منظم وقابل للمراجعة - الرسوم البيانية والإطارات السلكية والتعليمات البرمجية المشروحة والتعليقات وروابط المشاركة. التثبيت مرة واحدة من CLI؛ المراجعون الذين تشاركهم مع التعديل كضيف ولا تقم بتسجيل الدخول إلا للحفظ أو المشاركة."
---
...
خطط Jami Studio هي وضع خطة مرئية لوكلاء الترميز. يتحول إلى عادي
...
استخدم Jami Studio CLI. هذا هو الإعداد الموصى به لأنه يقوم بتثبيت
...
`https://plan.jami.studio/_agent-native/mcp` — راجع [MCP Clients](/docs/mcp-clients) للتعرف على الإعداد الخاص بالعميل.
...
الموصل، لذا استخدم مسار Jami Studio CLI عندما تريد الإعداد بأمر واحد.

> **هل تفضل تثبيت مكون إضافي مرة واحدة؟** يمكن إضافة رمز Claude وCodex
> `Jami Studio/agent-native` مباشرة كسوق للمكونات الإضافية، والذي يجمع
...
ويتضمن أمرًا لتشغيل تدفق الاتصال Jami Studio MCP الحالي لـ VS
...
موصل الخطط المستضاف موجود في `https://plan.jami.studio/_agent-native/mcp`.
...
يمنع وضع الملفات المحلية الخطة أو محتوى التلخيص من الانتقال إلى Jami Studio
...
يوفر Jami Studio Desktop أيضًا للخطط المستضافة جسر مجلد محلي أصلي. هذا
...
افتح خطة في Jami Studio Desktop، واستخدم **الملفات المحلية** actions بقائمة الخطة،
ثم:
...
- التطبيق: `https://plan.jami.studio`
...
- [**Skills**](/docs/skills-guide) — كيفية تثبيت Jami Studio لـ skills
