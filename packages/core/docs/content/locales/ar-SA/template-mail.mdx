...
عرض توضيحي مباشر: [mail.jami.studio](https://mail.jami.studio).

> **قد تعرض Google تحذيرًا:** يستخدم العرض التوضيحي المستضاف تطبيق Google المشترك الخاص بـ Jami Studio للوصول إلى Gmail، لذلك قد تطلب منك Google التأكيد قبل المتابعة. قم بالتشغيل محليًا لاستخدام عميل Google OAuth الخاص بك.
