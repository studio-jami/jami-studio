...
داخل الدردشة الخاصة بتطبيق Jami Studio، تفضل [native chat renderers](/docs/native-chat-ui) لعناصر واجهة المستخدم الخاصة بالطرف الأول مثل الجداول والمخططات والنتائج المكتوبة وتكاليف الموافقة. استخدم تطبيقات MCP للمضيف الخارجي/المضيف المضمن UI في Claude، وChatGPT، وCopilot، وCursor، والمضيفين المتوافقين الآخرين، مع الإجراء `link` باعتباره الإجراء الاحتياطي العالمي للارتباط العميق.
