...
عرض توضيحي مباشر: [design.jami.studio](https://design.jami.studio).
...
- **استيراد** — `index-design-system-with-builder` for Jami Studio-backed code/GitHub/Figma file design-system indexing, plus `import-from-url`, `import-document` (DOCX/PPTX/PDF/XLSX), and `import-design-project` for other sources.
