...
- **إطار سحابي Jami Studio** — إطار مُدار ومستضاف بالتعاون،
...
<div class="diagram-frames">
  ...
  <div class="diagram-card" data-rough>
    <span class="diagram-pill">إطار سحابي Jami Studio</span
...
- **وضع الكود** — يضيف أدوات الترميز المشتركة (`bash`، `read`، `edit`، `write`)
  ...
  مربع حوار يوضح أن تغييرات التعليمات البرمجية تحتاج إلى Jami Studio Desktop أو Jami Studio؛
...
<Diagram id="doc-block-11eq1v0" title={"بوابة طلب الكود"} summary={"تحتاج الرسالة المكتوبة بالرمز إلى إطار قادر على البرمجة. مع اتصال واحد، يتم توجيه الطلب إلى هناك؛ بدون واحد، تشرح اللوحة أن تغييرات التعليمات البرمجية تحتاج إلى Desktop أو Jami Studio."}>
...
## إطار سحابي Jami Studio {#cloud-frame}

يوفر [Jami Studio](https://www.jami.studio) إطارًا مُدارًا يستضيف
...
طلبات التعليمات البرمجية من مسار اللوحة المضمنة إلى إطار Jami Studio بنفس الطريقة
