...
description: "برامج عرض الدردشة الأصلية المعلنة عن إجراء، ومخرجات DataTable/DataChart القابلة لإعادة الاستخدام، وكيف يجب أن تتصل أوقات تشغيل وكيل BYO بدردشة Jami Studio."
---
...
بث الأحداث التي تمت تسويتها في محادثة Jami Studio UI مع الاحتفاظ بـ
...
<Diagram id="doc-block-1qei37v" title={"يحتفظ وقت تشغيل BYO بقشرة الدردشة Jami Studio"} summary={"يقوم وكيلك الخارجي ببث الأحداث التي تمت تسويتها من خلال موصل؛ Jami Studio يحتفظ بالمؤلف والنص وبطاقات الأدوات والموافقات والأدوات الأصلية."}>
...
عندما تريد نقل Jami Studio المدمج ككائن وقت التشغيل، استخدم:
...
يمتلك النص الخارجي بالكامل ويريد فقط مؤلف Jami Studio
الحقل.
