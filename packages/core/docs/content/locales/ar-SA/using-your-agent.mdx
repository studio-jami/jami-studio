...
الفكرة المحددة وراء Jami Studio هي أن الوكيل وUI **شريكان متساويان** — راجع [What Is Agent-Native?](/docs/what-is-agent-native) لمعرفة السبب. يتناول هذا القسم النصف الآخر من هذا الوعد: ما تشعر به عند العمل فعليًا مع الوكيل بمجرد تثبيته بجوار تطبيقك.
...
**الصوت.** الملحن لديه ميكروفون. قم بإملاء طلب بدلاً من كتابته، مع خيارات الموفر التي تتراوح بين النسخ المستضاف لـ Jami Studio وإحضار مفتاحك الخاص إلى خيار احتياطي للمتصفح.
