...
- **إنشاء صور ومقاطع فيديو.** يتوفر إنشاء الصور المُدارة بواسطة Jami Studio عند تمكينه، ويعمل Gemini على تشغيل إنشاء الفيديو بالإضافة إلى إمكانية الرجوع اليدوي للصور.
...
عرض توضيحي مباشر: [assets.jami.studio](https://assets.jami.studio).
...
1. **التثبيت مرة واحدة.** يؤدي ذلك إلى إضافة تعليمات المهارة وتسجيل موصل MCP المستضاف معًا:
   ...
   ```باش
   npx skills@latest أضف Jami Studio/agent-native --أصول المهارة
   ```

   يقوم Vercel/open Skills CLI بتثبيت ملف التعليمات فقط؛ لا
   قم بتشغيل إعداد موصل MCP. استخدم مسار Jami Studio CLI أعلاه عندما تريد
   إعداد الأمر الواحد.
