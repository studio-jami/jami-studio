---
title: "التدويل"
description: "قم بترجمة تطبيقات Jami Studio باستخدام كتالوجات محلية مشتركة، ومنتقي اللغة، ولغة احتياطية للمتصفح، ومحتوى المستندات المدرك للغة المحلية."
---

# التدويل

يمكن لتطبيقات Jami Studio توطين إطار العمل والنموذج UI من خلال
...
قم بتنزيل اللغة النشطة. الرموز المحلية المدعومة هي `en-US`، `zh-CN`، `zh-TW`،
