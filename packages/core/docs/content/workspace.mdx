...
<div class="ws-map">
  ...
  <div class="diagram-card an">
    <span class="diagram-pill accent">Jami Studio workspace</span
...
| Claude Code / Codex              | Jami Studio workspace                             |
| -------------------------------- | -------------------------------------------------- |
