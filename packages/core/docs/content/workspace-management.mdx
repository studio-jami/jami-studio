...
This guide covers the operational side of running an Jami Studio workspace — how to branch, who reviews what, how to set up code ownership, and how the Dispatch control plane fits into your governance model.
...
Not everyone who needs to make changes is comfortable with git. [Jami Studio](https://www.jami.studio) supports a visual branching model that maps to git branches under the hood — useful for content and copy changes, layout adjustments, design iterations, and A/B testing without a dev environment.
...
Jami Studio workspaces often have multiple AI agents working on the same branch simultaneously. This is by design — the agents share a branch and push independently.
...
- [**Workspace**](/docs/workspace) — the customization layer this page governs (skills, memory, agents, MCP servers)
