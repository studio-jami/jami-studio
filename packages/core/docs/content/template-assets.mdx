---
title: "Assets"
description: "A Jami-powered digital asset manager and cross-agent generation service for brand-consistent media."
---

# Assets

Assets is an Jami Studio workspace for creating and managing brand-consistent media. It organizes uploads and generated results into libraries and folders, lets teams collect examples for blog heroes, diagrams, landing pages, product shots, videos, and logos, then routes generation through the agent chat so every asset can be reviewed and refined.
...
1. **Install once.** This adds the skill instructions and registers the hosted MCP connector together:
   ...
   run MCP connector setup. Use the Jami Studio CLI path above when you want
