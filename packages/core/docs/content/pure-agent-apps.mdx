...
description: "No-browser Jami Studio apps for scheduled jobs, queues, scripts, integration workers, and external agents."
---

# Automation-First Apps

Most Jami Studio products should start with chat and grow into inline results
...
same Jami Studio contract: actions, sessions, app state, history, settings,
credentials, and share records live in SQL.

<Diagram id="doc-block-automation-first" title="Automation-first still uses the app contract" summary={"Jobs, scripts, channels, and external agents reach one Jami Studio loop over SQL-backed actions and state."}>
