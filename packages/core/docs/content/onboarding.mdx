...
When you first open an app built on Jami Studio, you'll see a
...
<div class="ob">
  <div class="diagram-card">
    ...
    ><small class="diagram-muted"
      >Connect Jami Studio (one click) or paste an LLM key</small
    >
  </div>
  <div class="diagram-card">
...
- **Connect an AI engine** (required) — the only mandatory step. Connect
  Jami Studio for a one-click managed gateway, or open the secondary provider-key
...
| `builder-cli-auth` | `{ scope: "llm" \| "browser" \| "image-generation" }` | Connect Jami Studio (unlocks shared infra) |
...
| ---------- | -------- | ------------------------------------------------- |
| `llm`      | yes      | Jami Studio connection or a provider LLM key      |
