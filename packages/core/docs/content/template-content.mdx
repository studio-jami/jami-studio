...
Live demo: [content.jami.studio](https://content.jami.studio).
...
`/local-files`, choose a folder in your browser or Jami Studio Desktop, and
...
and `resources/`. When a local Content app, Jami Studio Desktop, or trusted
...
guarded native folder bridge inside Jami Studio Desktop, to read and write
...
mode and Jami Studio Desktop, and Reveal in Finder is available through the
...
Content locally or use Jami Studio Desktop so the selected workspace path can
