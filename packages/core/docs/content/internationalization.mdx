...
description: "Localize Jami Studio apps with shared locale catalogs, a language picker, browser-language fallback, and locale-aware docs content."
---

# Internationalization

Jami Studio apps can localize framework and template UI through the shared
