---
title: "Chat Template"
description: "A minimal chat-first Jami Studio app: durable chat threads, actions, application state, live sync, auth, and room to add your own UI."
---
...
- **You want the default Jami Studio on-ramp**: chat first, then actions, native results, and app pages.
- **You want to plug your own agent backend into a familiar chat UI** while keeping Jami Studio's actions, state, auth, and deployment shape.
