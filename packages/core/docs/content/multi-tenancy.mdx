---
title: "Multi-Tenancy"
description: "Every Jami Studio app is multi-tenant out of the box — organizations, team members, roles, and per-org data isolation, with zero configuration."
---

# Multi-Tenancy

Every Jami Studio app is multi-tenant out of the box. Organizations, team members, role-based access, and per-org data isolation are built into the framework with zero configuration.
...
If you're evaluating Jami Studio for a CRM, project tracker, support inbox, or any team tool, the multi-tenant foundation is already there. All first-party templates are multi-tenant — see [Templates](/docs/cloneable-saas) for the list.
...
- [**Multi-App Workspace**](/docs/multi-app-workspace) — hosting multiple Jami Studio apps in one monorepo with shared auth and RBAC
