...
<Diagram id="doc-block-11vh2b" title={"add prints a recipe; your coding agent applies it"} summary={"The CLI emits a Markdown blueprint to stdout (diagnostics to stderr); you pipe it into Claude Code or Codex, which edits your live repo with full context."}>
...
1. **A one-line goal** and a "you are a coding agent in a Jami Studio app, apply these as real source changes" framing.
