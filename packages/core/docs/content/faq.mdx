...
If you'd rather not manage any of this, the hosted version on `agent-native.com` (operated by Jami Studio) bundles inference and hosting into a per-seat plan.
