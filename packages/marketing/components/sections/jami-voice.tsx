  ...
  return (
    <section id="jami" className="bg-background border-t border-border overflow-hidden" aria-labelledby="jami-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10 py-20 md:py-28">
        ...
        <div
          className={cn(
            "border border-t-0 border-border border-l-4 p-10 md:p-14 transition-all duration-150",
            mode.border,
          )}
          role="tabpanel"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            <div>
              <p
                className={cn(
                  "font-mono text-[0.62rem] uppercase tracking-[0.24em] mb-5",
                  mode.accent,
                )}
              >
                {mode.tag}
            ...
            <blockquote className="bg-card border border-border p-8 flex flex-col justify-between">
              <div>
                ...
                <p className="font-serif italic text-[1.3rem] leading-snug text-foreground mb-6">
                  &ldquo;Voice-first when you want flow; full UI when you need
                  precision.&rdquo;
                </p>
              </div>
              ...
              <div className="w-full bg-muted/20 border border-border rounded-md mt-6 overflow-hidden relative aspect-video flex items-center justify-center group cursor-pointer">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-12 h-12 rounded-full bg-background/80 border border-border flex items-center justify-center backdrop-blur-sm shadow-sm group-hover:scale-110 transition-transform">
                    <svg
                      className="w-4 h-4 ml-1 text-foreground"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
