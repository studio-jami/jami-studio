...
- Carry-through tracking: the deferred upstream-blocked alerts (#24, #36, #37) and the decision on how we handle this class of alert live in `_ops/planning/decisions/2026-07-08-upstream-blocked-dependency-alerts.md`. Recheck and close there as each blocking upstream advances.
