const messages = {
  ...
  builderCredits: {
    pausedTitle: "Jami Studio クレジットは一時停止中",
    transcriptionDescription:
      "バックアップ文字起こしを再開するには Jami Studio をアップグレードしてください。既存のネイティブ文字起こしは表示されたままです。",
    cleanupDescription:
      "文字起こしのクリーンアップ、要約、AI タイトルを再開するには Jami Studio をアップグレードしてください。ネイティブ文字起こしは保持されました。",
    settingsDescription:
      "バックアップ文字起こし、文字起こしのクリーンアップ、要約、AI タイトルを再開するには Jami Studio をアップグレードしてください。既存のネイティブ文字起こしは表示されたままです。",
    titleDescription:
      "AI タイトル生成は一時停止中です。文字起こしは引き続き使えます。",
    upgrade: "Jami Studio をアップグレード",
  ...
  recordingPage: {
    ...
    finishBuilderOrS3:
      "Jami Studio ポップアップを終了するか、S3 ストレージを構成してから、再試行してください。",
    ...
    loomSourcePreserved:
      "Loom ソース リンクは保持されます。 Jami Studio または S3 ストレージを接続すると、Clips は自身のコピーの保存を再試行します。",
    clipDataPreserved:
      "クリップデータは引き続き保存されます。 Jami Studio または S3 ストレージを接続すると、Clips が自動的にアップロードします。",
    details: "詳細",
  ...
  sharePage: {
    ...
    loomPreservedManage:
      "Loom ソース リンクは保持されます。 Jami Studio または S3 ストレージを接続してから、インポートを再試行してください。",
    videoPreservedManage:
      "ビデオは保存されています。 Jami Studio または S3 ストレージを接続すると、Clips がアップロードを完了します。",
    creatorNeedsStorage:
      "このクリップが終了する前に、作成者は Jami Studio または S3 ストレージに接続する必要があります。",
    signInStorage:
      "これが自分のクリップの場合は、ここにサインインして Jami Studio または S3 ストレージに接続し、アップロードを完了します。",
  ...
  transcriptPanel: {
    ...
    providerNeedsAttentionDescription:
      "現在のプロバイダーがこのリクエストを一時停止しました。Jami Studio に切り替えるかキーを更新してから再試行してください。",
    ...
    cleanupBuilderFailed:
      "Jami Studio が接続されているにもかかわらず、クリーンアップが完了できませんでした。ネイティブのトランスクリプトが保存されました。",
    cleanupPaused:
      "クリーンアップは一時停止されています。設定で AI を接続してください: Jami Studio (無料クレジット) または自分の LLM キー。",
    builderNoResponse:
...
- Clips 内で最新情報を直接確認できるようになりました。変更履歴はコマンドメニュー（Cmd+K）と設定にあります。`,
    ...
    saved: "設定を保存しました",
    saveFailed: "保存に失敗しました",
    builderConnectedToast: "Jami Studio に接続しました",
    videoStorage: "動画ストレージ",
    videoStorageDescription:
      "Jami Studio は Clips アップロードの主要な保存先です。独自バケットが必要な場合は S3 も利用できます。",
    checkingBuilder: "Jami Studio を確認中",
    builderConnected: "Jami Studio 接続済み",
    connectBuilder: "Jami Studio を使用 (無料)",
    builderConnectedFor: "{{orgName}} で Jami Studio を使用中です。",
    builderConnectedGeneric:
      "新しいクリップは接続済みの Jami Studio プロバイダーを使用します。",
    builderIncludes:
    ...
    s3BuilderConnectedDescription:
      "このワークスペースを Jami Studio ではなく独自バケットにアップロードする場合のみ使用してください。",
    s3CurrentProvider: "現在 {{providerName}} を使用中です。",
    s3OwnBucketDescription:
      "Jami Studio ストレージを使わない場合は独自バケットを使用してください。",
    configureS3: "S3 を設定",
    hideS3: "S3 を非表示",
    ...
    apiSetup: "AI 設定",
    apiSetupDescription:
      "Jami Studio の無料クレジット、または自分の LLM キーで AI を接続します。",
    builderEasySetup: "Jami Studio 無料クレジット",
    builderAiAvailable:
      "Clips では付属の AI クレジットとマネージド文字起こしを利用できます。",
    builderAiDescription:
      "含まれる AI クレジット、オブジェクトストレージ、アップロード、管理された文字起こしには、まず Jami Studio を使用します。",
  ...
  stitchManager: {
    ...
    connectStorage:
      "録画を結合する前にストレージを接続してください: Jami Studio (無料プランのストレージ + AI) または S3 互換ストレージ。",
    created: "結合録画を作成しました",
    failed: "録画の結合に失敗しました",
  ...
  storageSetup: {
    builderTimeout:
      "5分以内に Jami Studio から応答がありませんでした。ポップアップを確認してもう一度お試しください。",
    builderConnected: "Jami Studio 接続済み",
    waitingForBuilder: "Jami Studio を待機中...",
    connectBuilder: "Jami Studio を使用 (無料)",
    free: "無料",
    configureS3: "S3 互換ストレージを設定",
    whyPrompt: "なぜこれが表示されていますか？",
    whyDescription:
      "Clips は 100% 無料でオープンソースのアプリなので、クリップを保存する方法を接続する必要があります。Jami Studio で無料プランのストレージと AI を使うか、S3 互換オブジェクトストレージと自分の LLM キーを使用します。",
  },
  captureInstall: {
  ...
  recordRoute: {
    ...
    connectStorageToFinish:
      "次の画面でストレージを接続してください: Jami Studio (無料プランのストレージ + AI) または S3 互換ストレージ。Clips が保存を完了します。",
    connectStorageToRetryLoom:
      "次の画面でストレージを接続してください: Jami Studio (無料プランのストレージ + AI) または S3 互換ストレージ。Clips がインポートを再試行します。",
  },
  dictateRoute: {
