const messages = {
  ...
  builderCredits: {
    pausedTitle: "Jami Studio क्रेडिट रुके हुए हैं",
    transcriptionDescription:
      "बैकअप ट्रांसक्रिप्शन फिर शुरू करने के लिए Jami Studio अपग्रेड करें। मौजूदा नेटिव ट्रांसक्रिप्ट दिखाई देते रहेंगे।",
    cleanupDescription:
      "ट्रांसक्रिप्ट क्लीनअप, सारांश और AI शीर्षक फिर शुरू करने के लिए Jami Studio अपग्रेड करें। नेटिव ट्रांसक्रिप्ट सुरक्षित रखा गया।",
    settingsDescription:
      "बैकअप ट्रांसक्रिप्शन, ट्रांसक्रिप्ट क्लीनअप, सारांश और AI शीर्षक फिर शुरू करने के लिए Jami Studio अपग्रेड करें। मौजूदा नेटिव ट्रांसक्रिप्ट दिखाई देते रहेंगे।",
    titleDescription:
      "AI शीर्षक जनरेशन रुका हुआ है। आपका ट्रांसक्रिप्ट अब भी काम करता है।",
    upgrade: "Jami Studio अपग्रेड करें",
  ...
  recordingPage: {
    ...
    finishBuilderOrS3:
      "Jami Studio पॉपअप समाप्त करें या S3 स्टोरेज कॉन्फ़िगर करें, फिर पुनः प्रयास करें।",
    ...
    loomSourcePreserved:
      "Loom स्रोत लिंक संरक्षित है। Jami Studio या S3 स्टोरेज कनेक्ट करें और Clips अपनी कॉपी को सहेजने का पुनः प्रयास करेगा।",
    clipDataPreserved:
      "आपका क्लिप डेटा अभी भी संरक्षित है. Jami Studio या S3 स्टोरेज कनेक्ट करें और Clips इसे स्वचालित रूप से अपलोड कर देगा।",
    details: "विवरण",
  ...
  sharePage: {
    ...
    loomPreservedManage:
      "Loom स्रोत लिंक संरक्षित है। Jami Studio या S3 स्टोरेज कनेक्ट करें, फिर आयात का पुनः प्रयास करें।",
    videoPreservedManage:
      "वीडियो सुरक्षित रखा गया है. Jami Studio या S3 स्टोरेज कनेक्ट करें और Clips इसे अपलोड करना समाप्त कर देगा।",
    creatorNeedsStorage:
      "इस क्लिप के समाप्त होने से पहले निर्माता को Jami Studio या S3 स्टोरेज कनेक्ट करना होगा।",
    signInStorage:
      "यदि यह आपकी क्लिप है, तो Jami Studio या S3 स्टोरेज को कनेक्ट करने और अपलोड समाप्त करने के लिए यहां साइन इन करें।",
  ...
  transcriptPanel: {
    ...
    providerNeedsAttentionDescription:
      "मौजूदा प्रदाता ने यह अनुरोध रोक दिया है। Jami Studio पर जाएँ या कुंजी अपडेट करें, फिर दोबारा कोशिश करें।",
    ...
    cleanupBuilderFailed:
      "Jami Studio कनेक्ट होने के बावजूद सफाई समाप्त नहीं हो सकी। मूल प्रतिलेख रखा गया था.",
    cleanupPaused:
      "क्लीनअप रुका है। सेटिंग्स में AI कनेक्ट करें: Jami Studio (मुफ्त क्रेडिट) या अपनी LLM key.",
    builderNoResponse:
...
- अब आप Clips के अंदर ही नया क्या है देख सकते हैं। बदलाव लॉग अब कमांड मेनू (Cmd+K) और सेटिंग्स में उपलब्ध है।`,
    ...
    saveFailed: "सहेजने में विफल",
    builderConnectedToast: "Jami Studio कनेक्टेड",
    videoStorage: "वीडियो स्टोरेज",
    videoStorageDescription:
      "Jami Studio Clips अपलोड के लिए मुख्य स्टोरेज पथ है। अपना bucket लाने की ज़रूरत हो तो S3 उपलब्ध है।",
    checkingBuilder: "Jami Studio जाँचा जा रहा है",
    builderConnected: "Jami Studio कनेक्टेड",
    connectBuilder: "Jami Studio इस्तेमाल करें (मुफ्त)",
    builderConnectedFor: "{{orgName}} के लिए Jami Studio इस्तेमाल हो रहा है।",
    builderConnectedGeneric:
      "नई क्लिप्स कनेक्टेड Jami Studio प्रोवाइडर का उपयोग करती हैं।",
    builderIncludes:
    ...
    s3BuilderConnectedDescription:
      "इसे केवल तब इस्तेमाल करें जब यह वर्कस्पेस Jami Studio के बजाय आपके अपने bucket में अपलोड करे।",
    s3CurrentProvider: "अभी {{providerName}} इस्तेमाल हो रहा है।",
    s3OwnBucketDescription:
      "यदि आप Jami Studio स्टोरेज नहीं चाहते हैं तो अपना bucket इस्तेमाल करें।",
    ...
    apiSetup: "AI सेटअप",
    apiSetupDescription:
      "Jami Studio मुफ्त क्रेडिट या अपनी LLM keys के साथ AI कनेक्ट करें.",
    builderEasySetup: "Jami Studio मुफ्त क्रेडिट",
    builderAiAvailable:
      "Clips के लिए शामिल AI क्रेडिट और मैनेज्ड ट्रांसक्रिप्शन उपलब्ध हैं।",
    builderAiDescription:
      "शामिल AI क्रेडिट, ऑब्जेक्ट स्टोरेज, अपलोड और managed transcription के लिए पहले Jami Studio इस्तेमाल करें.",
  ...
  stitchManager: {
    ...
    connectStorage:
      "रिकॉर्डिंग जोड़ने से पहले स्टोरेज कनेक्ट करें: Jami Studio (free tier storage + AI) या S3-संगत स्टोरेज.",
  ...
  storageSetup: {
    builderTimeout:
      "5 मिनट में Jami Studio से जवाब नहीं मिला। पॉपअप जांचें और फिर कोशिश करें।",
    builderConnected: "Jami Studio कनेक्ट है",
    waitingForBuilder: "Jami Studio की प्रतीक्षा...",
    connectBuilder: "Jami Studio इस्तेमाल करें (मुफ्त)",
    free: "मुफ्त",
    configureS3: "S3-संगत स्टोरेज कॉन्फ़िगर करें",
    whyPrompt: "मैं यह क्यों देख रहा हूं?",
    whyDescription:
      "Clips 100% मुफ्त और ओपन सोर्स ऐप है, इसलिए आपको क्लिप स्टोर करने का तरीका जोड़ना होगा। Jami Studio से free-tier storage और AI वाला स्टोरेज कनेक्ट करें, या S3-संगत ऑब्जेक्ट स्टोरेज और अपनी LLM keys इस्तेमाल करें.",
  },
  captureInstall: {
  ...
  recordRoute: {
    ...
    connectStorageToFinish:
      "अगली स्क्रीन पर स्टोरेज कनेक्ट करें: Jami Studio (free tier storage + AI) या S3-संगत स्टोरेज. Clips सेव पूरा करेगा.",
    connectStorageToRetryLoom:
      "अगली स्क्रीन पर स्टोरेज कनेक्ट करें: Jami Studio (free tier storage + AI) या S3-संगत स्टोरेज. Clips इंपोर्ट फिर से करेगा.",
  },
  dictateRoute: {
