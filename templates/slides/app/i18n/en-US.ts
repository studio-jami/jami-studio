const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "Could not start Jami Studio indexing for that Figma file.",
    ...
    newDescription:
      "Connect Figma, code, and optional design.md guidance through Jami Studio DSI.",
    companyBrand: "Company / Brand",
    companyBrandPlaceholder: "Acme Inc. — We build developer tools...",
    figmaFile: "Connect Figma",
    parsingFigmaFile: "Starting Jami Studio DSI indexing...",
    uploadFigDescription: "Upload a .fig local copy for Jami Studio DSI",
    builderIndexingStarted: "Jami Studio indexing started",
    builderIndexingDescription:
      "Jami Studio is indexing {{title}} into a reusable design system.",
    builderDesignSystemId: "Design system",
    builderJobId: "Job",
    openInBuilder: "Open in Jami Studio",
