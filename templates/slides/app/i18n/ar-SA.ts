...
const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "تعذر بدء فهرسة Jami Studio لملف Figma هذا.",
    ...
    newDescription:
      "اربط Figma والكود وإرشادات design.md الاختيارية عبر Jami Studio DSI.",
    companyBrand: "الشركة / العلامة",
    companyBrandPlaceholder: "Acme Inc. — نبني أدوات للمطورين...",
    figmaFile: "ربط Figma",
    parsingFigmaFile: "جارٍ بدء فهرسة Jami Studio DSI...",
    uploadFigDescription: "حمّل نسخة .fig محلية إلى Jami Studio DSI",
    builderIndexingStarted: "بدأت فهرسة Jami Studio",
    builderIndexingDescription:
      "Jami Studio is indexing {{title}} into a reusable design system.",
    builderDesignSystemId: "نظام التصميم",
    builderJobId: "Job",
    openInBuilder: "فتح في Jami Studio",
