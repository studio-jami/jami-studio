const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed:
      "해당 Figma 파일의 Jami Studio 색인 생성을 시작할 수 없습니다.",
    ...
    newDescription:
      "Figma, 코드, 선택적 design.md 지침을 Jami Studio DSI로 연결하세요.",
    companyBrand: "회사 / 브랜드",
    companyBrandPlaceholder: "Acme Inc. — 개발자 도구를 만듭니다...",
    figmaFile: "Figma 연결",
    parsingFigmaFile: "Jami Studio DSI 색인 생성을 시작하는 중...",
    uploadFigDescription: "Jami Studio DSI용 로컬 .fig 사본 업로드",
    builderIndexingStarted: "Jami Studio 색인 생성 시작됨",
    builderIndexingDescription:
      "Jami Studio is indexing {{title}} into a reusable design system.",
    builderDesignSystemId: "디자인 시스템",
    builderJobId: "Job",
    openInBuilder: "Jami Studio에서 열기",
    websiteUrl: "웹사이트 URL",
