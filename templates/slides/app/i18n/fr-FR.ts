...
const messages = {
  ...
  designSystemSetup: {
    ...
    newDescription:
      "Connectez Figma, le code et les consignes design.md facultatives via Jami Studio DSI.",
    ...
    parsingFigmaFile: "Démarrage de l’indexation Jami Studio DSI...",
    uploadFigDescription: "Importez une copie locale .fig pour Jami Studio DSI",
    builderIndexingStarted: "Indexation Jami Studio démarrée",
    ...
    builderJobId: "Job",
    openInBuilder: "Ouvrir dans Jami Studio",
