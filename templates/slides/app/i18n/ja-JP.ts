const messages = {
  ...
  designSystemSetup: {
    ...
    newDescription:
      "Figma、コード、任意の design.md ガイドを Jami Studio DSI で接続します。",
    companyBrand: "会社 / ブランド",
    companyBrandPlaceholder: "Acme Inc. — 開発者向けツールを作っています...",
    figmaFile: "Figma を接続",
    parsingFigmaFile: "Jami Studio DSI のインデックス作成を開始しています...",
    uploadFigDescription:
      "Jami Studio DSI 用にローカル .fig コピーをアップロード",
    builderIndexingStarted: "Jami Studio インデックス作成を開始しました",
    builderIndexingDescription:
      "Jami Studio is indexing {{title}} into a reusable design system.",
    builderDesignSystemId: "デザインシステム",
    builderJobId: "Job",
    openInBuilder: "Jami Studio で開く",
