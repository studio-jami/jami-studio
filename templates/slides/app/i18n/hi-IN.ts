const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "उस Figma फ़ाइल के लिए Jami Studio indexing शुरू नहीं हो सकी।",
    ...
    newDescription:
      "Figma, कोड और वैकल्पिक design.md मार्गदर्शन को Jami Studio DSI से कनेक्ट करें.",
    companyBrand: "कंपनी / ब्रांड",
    companyBrandPlaceholder: "Acme Inc. — हम डेवलपर टूल बनाते हैं...",
    figmaFile: "Figma कनेक्ट करें",
    parsingFigmaFile: "Jami Studio DSI indexing शुरू की जा रही है...",
    uploadFigDescription: "Jami Studio DSI के लिए स्थानीय .fig कॉपी अपलोड करें",
    builderIndexingStarted: "Jami Studio indexing शुरू हुई",
    ...
    builderJobId: "Job",
    openInBuilder: "Jami Studio में खोलें",
