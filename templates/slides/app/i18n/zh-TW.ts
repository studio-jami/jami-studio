const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "無法為該 Figma 檔案啟動 Jami Studio 索引。",
    updated: "設計系統已更新",
    updateFailed: "更新失敗",
    ...
    newDescription:
      "透過 Jami Studio DSI 連接 Figma、程式碼和選用的 design.md 指引。",
    companyBrand: "公司 / 品牌",
    companyBrandPlaceholder: "Acme Inc. — 我們建置開發者工具...",
    figmaFile: "連接 Figma",
    parsingFigmaFile: "正在啟動 Jami Studio DSI 索引...",
    uploadFigDescription: "上傳本機 .fig 副本以用於 Jami Studio DSI",
    builderIndexingStarted: "Jami Studio 索引已啟動",
    builderIndexingDescription:
      "Jami Studio is indexing {{title}} into a reusable design system.",
    builderDesignSystemId: "設計系統",
    builderJobId: "Job",
    openInBuilder: "在 Jami Studio 中開啟",
    websiteUrl: "網站 URL",
