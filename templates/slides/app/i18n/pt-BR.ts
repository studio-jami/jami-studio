const messages = {
  ...
  designSystemSetup: {
    ...
    newDescription:
      "Conecte Figma, código e orientações opcionais de design.md pelo Jami Studio DSI.",
    ...
    parsingFigmaFile: "Iniciando indexação do Jami Studio DSI...",
    uploadFigDescription: "Envie uma cópia local .fig para o Jami Studio DSI",
    builderIndexingStarted: "Indexação do Jami Studio iniciada",
    ...
    builderJobId: "Job",
    openInBuilder: "Abrir no Jami Studio",
