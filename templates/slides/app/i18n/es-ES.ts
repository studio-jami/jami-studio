const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed:
      "No se pudo iniciar la indexación de Jami Studio para ese archivo de Figma.",
    ...
    newDescription:
      "Conecta Figma, código y guía opcional de design.md mediante Jami Studio DSI.",
    ...
    parsingFigmaFile: "Iniciando indexación de Jami Studio DSI...",
    uploadFigDescription: "Sube una copia local .fig para Jami Studio DSI",
    builderIndexingStarted: "Indexación de Jami Studio iniciada",
    ...
    builderJobId: "Job",
    openInBuilder: "Abrir en Jami Studio",
