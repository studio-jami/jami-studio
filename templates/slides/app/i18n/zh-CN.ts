const messages = {
  ...
  designSystemSetup: {
    ...
    figParseFailed: "无法为该 Figma 文件启动 Jami Studio 索引。",
    updated: "设计系统已更新",
    updateFailed: "更新失败",
    ...
    newDescription:
      "通过 Jami Studio DSI 连接 Figma、代码和可选的 design.md 指引。",
    companyBrand: "公司 / 品牌",
    companyBrandPlaceholder: "Acme Inc. — 我们构建开发者工具...",
    figmaFile: "连接 Figma",
    parsingFigmaFile: "正在启动 Jami Studio DSI 索引...",
    uploadFigDescription: "上传本地 .fig 副本以用于 Jami Studio DSI",
    builderIndexingStarted: "Jami Studio 索引已启动",
    builderIndexingDescription:
      "Jami Studio is indexing {{title}} into a reusable design system.",
    builderDesignSystemId: "设计系统",
    builderJobId: "Job",
    openInBuilder: "在 Jami Studio 中打开",
    websiteUrl: "网站 URL",
