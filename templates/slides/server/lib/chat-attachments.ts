  ...
  const attachmentContext = [
    ...
    uploaded.length > 0
      ? [
          ...
          '- Figma `.fig` files: call `import-file --filePath "<path>" --format fig` to start Jami Studio design-system indexing. Do not create a local design system directly from the upload.',
