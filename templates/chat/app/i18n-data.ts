...
const enUS = {
  ...
  chat: {
    ...
    inspectSuggestionHello: "Call hello for Jami Studio",
...
export const messagesByLocale = {
  ...
  "zh-CN": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "为 Jami Studio 调用 hello",
  ...
  "es-ES": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "Llama a hello para Jami Studio",
  ...
  "fr-FR": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "Appelle hello pour Jami Studio",
  ...
  "de-DE": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "Rufe hello für Jami Studio auf",
  ...
  "ja-JP": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "Jami Studio に hello を呼び出す",
  ...
  "ko-KR": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "Jami Studio용 hello 호출",
  ...
  "pt-BR": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "Chame hello para Jami Studio",
  ...
  "hi-IN": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "Jami Studio के लिए hello call करें",
  ...
  "ar-SA": mergeMessages({
    ...
    chat: {
      ...
      inspectSuggestionHello: "استدع hello لـ Jami Studio",
