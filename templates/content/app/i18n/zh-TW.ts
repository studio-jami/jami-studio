const messages = {
  ...
  database: {
    ...
    builderWriteMode: "Jami Studio 寫入模式",
    builderWriteModeUpdated: "已更新 Jami Studio 寫入模式",
    allowPublishUnpublishPerItem: "允許逐項發佈/取消發佈",
    builderChanges: "Jami Studio 變更",
    reviewLocalEditsBeforeBuilder: "在本機編輯到達 Jami Studio 之前進行審查。",
    ...
    connectABuilderCollectionToMapRows:
      "連接 Jami Studio 集合或其他表格以對應到這些列。",
    noBuilderWrites: "無 Jami Studio 寫入。",
    stageOnly: "僅暫存",
    savesDraftsNeverPublishes: "將草稿儲存到 Jami Studio — 從不發佈。",
    publishUpdates: "發佈更新",
    ...
    changedInBuilderSinceSync:
      "自您同步以來在 Jami Studio 中已變更 — 推送前請審查。",
    thisUnpublishesTheLiveEntry: "這會取消發佈 Jami Studio 中的即時項目。",
    needsAttentionBeforeFinish: "完成前需要處理",
    noPendingLocalBuilderChanges: "尚無待處理的本機 Jami Studio 變更。",
    needsAttention: "需要處理",
    ...
    addProperty: "新增屬性",
    back: "返回",
    builderSpace: "Jami Studio 空間",
    builderUpdateFailed: "Jami Studio 更新失敗",
    builderWriteModeWasNotChanged: "Jami Studio 寫入模式未更改",
    builderBodiesReadyLocally: "Jami Studio 文章正文已在本機準備好。",
    ...
    rowOptions: "行選項",
    search: "搜尋",
    searchBuilderModels: "搜尋 Jami Studio 模型",
    ...
    builderIsntConnectedGoBackToConnectYour:
      "Jami Studio 未連線。請先返回並連線你的帳戶。",
    calculate: "Calculate",
    calendarBy: "行事曆依據",
    cancel: "Cancel",
    checked: "Checked",
    checkingBuilderConnection: "正在檢查 Jami Studio 連線",
    clear: "清除",
    clearAll: "全部清除",
    clearFilters: "清除篩選器",
    ...
    loadingBoard: "正在載入看板",
    loadingBuilderModels: "正在載入 Jami Studio 模型",
    ...
    newView: "新檢視",
    noBuilderModelsWereFoundInThisSpace: "此空間中未找到 Jami Studio 模型。",
    ...
    none: "None",
    notMappedToBuilder: "未對應到 Jami Studio。",
    openPage: "開啟頁面",
    openPagesIn: "開啟頁面位置",
    ...
    resume: "繼續",
    retry: "Retry",
    reviewBeforeTheyReachBuilder: "在傳送到 Jami Studio 前審核。",
    reviewDiff: "審核差異",
    sampleMatches: "範例匹配",
    showAll: "顯示全部",
    sortAscending: "升序排序",
    ...
    builderApiReadOnly: "Jami Studio API 唯讀",
    builderBodyEditsNeedSaferPath:
      "Jami Studio 本文編輯需要更安全的送出路徑才能送出。",
    builderCheckingGate: "正在本機檢查 Jami Studio gate。",
    builderCheckedNothingSent: "已完成檢查。未送出任何內容到 Jami Studio。",
    builderModel: "Jami Studio 模型",
    builderPreparingGate: "正在準備 Jami Studio gate，並透過受保護路徑送出。",
    builderPushFinished: "Jami Studio 推送已完成。",
    builderPushedReconciled: "已送出至 Jami Studio 並完成本機對帳。",
    builderPushWillSend: "送出會透過受保護的 Jami Studio 路徑寫入 autosave。",
    builderWritesDisabledCheckOnly:
      "Jami Studio 寫入已停用。送出只會檢查更新。",
    canSendToBuilder: "可送出至 Jami Studio",
    checkedStatus: "已檢查",
    checking: "正在檢查...",
    checksOnly: "僅檢查",
    close: "關閉",
    closeBuilderUpdateReview: "關閉 Jami Studio 更新審查",
    disabled: "已停用",
    draft: "草稿",
    enabled: "已啟用",
    ...
    localReview: "本機審查",
    noPendingBuilderChanges: "沒有待處理的 Jami Studio 變更。",
    noPendingLocalBuilderChangesYet: "還沒有待處理的本機 Jami Studio 變更。",
    notConfigured: "未設定",
    plusBodyDiff: "加上本文差異",
    publish: "發布",
    push: "Push",
    ...
    readMode: "讀取模式",
    result: "結果",
    reviewBuilderUpdate: "審查 Jami Studio 更新",
    riskCheck: "風險檢查",
    riskLabel: "{{level}} 風險",
